-- ============================================================================
-- Add Classes Permissions
-- ============================================================================
-- Add permissions for classes management and assign to roles
-- ============================================================================

-- Insert classes permissions (global = organization_id NULL)
INSERT INTO
    public.permissions (
        name,
        resource,
...
VALUES (
    ...
    (
        'academic.classes.assign',
        'academic',
        'assign',
        'Assign classes to academic years',
        NULL
    ),
    (
        'academic.classes.copy',
        'academic',
        'copy',
...
-- Give super_admin global (organization_id NULL) access to all classes permissions
INSERT INTO
...
-- Update assign_default_role_permissions function to include classes permissions
...
-- Assign classes permissions to existing organizations' admin roles
DO $$
DECLARE
    org_record RECORD;
BEGIN
    ...
    LOOP
        -- Assign classes permissions to admin role for this organization
        INSERT INTO public.role_permissions (role, permission_id, organization_id)
        ...
        WHERE p.organization_id IS NULL
          AND p.name = 'academic.classes.read'
        ON CONFLICT DO NOTHING;
    END LOOP;
END;
$$;