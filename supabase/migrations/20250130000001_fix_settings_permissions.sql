-- Fix settings permissions for Settings, Users, Organizations, and Backup modules
-- This migration adds the correct permissions in resource.action format to match navigation checks
...
VALUES
    ...
    -- User management permissions (ensure they exist even if already added)
    ...
    -- Organization management (ensure they exist)
