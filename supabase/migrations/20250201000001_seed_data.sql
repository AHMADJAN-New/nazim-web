...
-- ============================================================================
-- Development super admin (email: admin@nazim.local / password: Admin123!@#)
-- ============================================================================
DO $$
DECLARE
...
BEGIN
    ...
    VALUES (existing_user, admin_email, admin_name, 'super_admin', NULL)
    ON CONFLICT (id) DO UPDATE
    SET role = 'super_admin', organization_id = NULL, deleted_at = NULL;
END;
$$;
