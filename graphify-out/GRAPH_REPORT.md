...
Cohesion: 0.02
Nodes (32): Donor, ExchangeRate, ExpenseEntry, FacilityDocument, FinanceAccount, FinanceDocument, FinanceProject, FinanceReportingService (+24 more)
...
Cohesion: 0.02
Nodes (21): FileMigrationService, FileStorageService, FileStorageServiceTest, ImageCompressionService, PlatformFile, PlatformFilesController, StudentDocument, StudentEducationalHistory (+13 more)
...
- **Thin community `Community 120`** (6 nodes): `LandingOffersPage.tsx`, `formatCountdown()`, `getLandingMetadata()`, `handleOpenDialog()`, `handleSave()`, `handleToggleLanding()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 122`** (5 nodes): `LogDownloadTraffic.php`, `LogDownloadTraffic`, `.handle()`, `.isDownloadResponse()`, `.isLargeResponse()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 123`** (5 nodes): `AssignClassToYearRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`, `AssignClassToYearRequest.php`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 124`** (5 nodes): `AttendanceScanRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`, `AttendanceScanRequest.php`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 125`** (5 nodes): `StoreAssetRequest.php`, `StoreAssetRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 126`** (5 nodes): `StoreAttendanceSessionRequest.php`, `StoreAttendanceSessionRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 127`** (5 nodes): `StoreBuildingRequest.php`, `StoreBuildingRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 128`** (5 nodes): `StoreClassRequest.php`, `StoreClassRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 129`** (5 nodes): `StoreCourseStudentRequest.php`, `StoreCourseStudentRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 130`** (5 nodes): `StoreReportTemplateRequest.php`, `StoreReportTemplateRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 131`** (5 nodes): `StoreRoomRequest.php`, `StoreRoomRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 132`** (5 nodes): `StoreScheduleSlotRequest.php`, `StoreScheduleSlotRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 133`** (5 nodes): `StoreStudentAdmissionRequest.php`, `StoreStudentAdmissionRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 134`** (5 nodes): `StoreStudentDisciplineRecordRequest.php`, `StoreStudentDisciplineRecordRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 135`** (5 nodes): `StoreStudentDocumentRequest.php`, `StoreStudentDocumentRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 136`** (5 nodes): `StoreStudentEducationalHistoryRequest.php`, `StoreStudentEducationalHistoryRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 137`** (5 nodes): `StoreStudentRequest.php`, `StoreStudentRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 138`** (5 nodes): `StoreSubjectRequest.php`, `StoreSubjectRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 139`** (5 nodes): `StoreTimetableRequest.php`, `StoreTimetableRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 140`** (5 nodes): `UpdateAssetRequest.php`, `UpdateAssetRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 141`** (5 nodes): `UpdateBuildingRequest.php`, `UpdateBuildingRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 142`** (5 nodes): `UpdateClassRequest.php`, `UpdateClassRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 143`** (5 nodes): `UpdateCourseStudentRequest.php`, `UpdateCourseStudentRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 144`** (5 nodes): `UpdateReportTemplateRequest.php`, `UpdateReportTemplateRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 145`** (5 nodes): `UpdateRoomRequest.php`, `UpdateRoomRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 146`** (5 nodes): `UpdateScheduleSlotRequest.php`, `UpdateScheduleSlotRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 147`** (5 nodes): `UpdateStudentAdmissionRequest.php`, `UpdateStudentAdmissionRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 148`** (5 nodes): `UpdateStudentDisciplineRecordRequest.php`, `UpdateStudentDisciplineRecordRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 149`** (5 nodes): `UpdateStudentEducationalHistoryRequest.php`, `UpdateStudentEducationalHistoryRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 150`** (5 nodes): `UpdateStudentRequest.php`, `UpdateStudentRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 151`** (5 nodes): `UpdateSubjectRequest.php`, `UpdateSubjectRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 152`** (5 nodes): `UpdateTeacherSubjectAssignmentRequest.php`, `UpdateTeacherSubjectAssignmentRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 153`** (5 nodes): `UpdateTimetableRequest.php`, `UpdateTimetableRequest`, `.authorize()`, `.prepareForValidation()`, `.rules()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 154`** (5 nodes): `DownloadStudentImportTemplateRequest.php`, `DownloadStudentImportTemplateRequest`, `.authorize()`, `.rules()`, `.withValidator()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
