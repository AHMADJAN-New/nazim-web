...
@section('content')
    ...
    <div class="report-header">
        ...
        <div class="header-left">
            @if(($show_primary_logo ?? true) && !empty($PRIMARY_LOGO_URI))
                <img src="{{ $PRIMARY_LOGO_URI }}" alt="Primary Logo" class="header-logo">
            @endif
        </div>
        ...
        <div class="header-right">
            ...
            @elseif(($show_ministry_logo ?? false) && !empty($MINISTRY_LOGO_URI))
                <img src="{{ $MINISTRY_LOGO_URI }}" alt="Ministry Logo" class="header-logo">
            @endif
        </div>
    </div>
    ...
    <div class="report-footer">
        ...
        @if(!empty($SCHOOL_WEBSITE) || !empty($SCHOOL_ADDRESS))
            <div class="footer-row">
                <div class="footer-left">
