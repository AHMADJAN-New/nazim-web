...
class PermissionSeeder extends Seeder
{
    ...
    public static function getPermissions(): array
    {
        return [
            ...
            'exam_seating_maps' => ['read', 'create', 'update', 'delete', 'assign', 'print'],
    ...
    public static function getRolePermissions(): array
    {
        return [
            ...
            'exam_controller' => [
                ...
                'exam_seating_maps.read', 'exam_seating_maps.create', 'exam_seating_maps.update',
                'exam_seating_maps.delete', 'exam_seating_maps.assign', 'exam_seating_maps.print',
                'academic_years.read',
                'grades.read', 'grades.create', 'grades.update', 'grades.delete',
                'profiles.read', 'profiles.update',
