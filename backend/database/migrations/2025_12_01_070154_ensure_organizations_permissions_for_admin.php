...
return new class extends Migration
{
     ...
     * 
     * Uses Spatie's standard role_has_permissions table only.
     */
    public function up(): void
    {
        ...
        // Use Spatie's standard role_has_permissions table
    ...
    public function down(): void
    {
        ...
        // Remove from Spatie's standard role_has_permissions table
        DB::statement("
