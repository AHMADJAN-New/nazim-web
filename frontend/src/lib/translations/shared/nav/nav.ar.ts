...
export default {
  nav: {
    ...
    organizationHrAssignments: "التعيينات",
    organizationHrPayroll: "الرواتب",
    organizationHrReports: "التقارير",
    organizationHrOpenModule: "فتح الوحدة",
    organizationHrSearchStaff: "بحث عن موظف",
    organizationHrLoading: "جارٍ التحميل...",
    organizationHrEmployeeId: "رقم الموظف",
    organizationHrName: "الاسم",
    organizationHrStatus: "الحالة",
    organizationHrNoStaff: "لم يتم العثور على موظفين",
    organizationHrAnalyticsRaw: "التحليلات (JSON خام)",
    documents: "Documents",
