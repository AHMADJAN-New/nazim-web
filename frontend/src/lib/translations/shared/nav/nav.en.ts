...
export default {
  nav: {
    ...
    organizationHrAssignments: "Assignments",
    organizationHrPayroll: "Payroll",
    organizationHrReports: "Reports",
    organizationHrOpenModule: "Open module",
    organizationHrSearchStaff: "Search staff",
    organizationHrLoading: "Loading...",
    organizationHrEmployeeId: "Employee ID",
    organizationHrName: "Name",
    organizationHrStatus: "Status",
    organizationHrNoStaff: "No staff found",
    organizationHrAnalyticsRaw: "Analytics (raw JSON)",
    documents: "Documents",
