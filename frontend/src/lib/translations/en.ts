...
export const en: TranslationKeys = {
  ...
  common: {
    ...
    searchAndFilters: 'Search & Filters',
    openMenu: 'Open Menu',
    schoolManagement: 'Nazim – Islamic School Management System',
    ...
    gradeExample: 'e.g. Grade 1, Grade 2',
    searchStudentPlaceholder: 'Search students...',
    courseNameExample: 'e.g. Advanced Web Development',
    exampleCategories: 'e.g. Electronics, Furniture',
    scanCardNumber: 'Scan card number',
    sectionExample: 'e.g. Section A',
    overrideCapacity: 'Override Capacity',
    overrideCapacityAll: 'Override capacity for all sections',
    sectionsInputHint: 'Separate sections with commas (e.g. A, B, C)',
    none: 'None',
    statusLabel: 'Status',
    ...
    notAssignedToOrganization: 'Not assigned to an organization',
