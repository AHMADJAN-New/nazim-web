...
export const en: TranslationKeys = {
  ...
  subscription: {
    ...
    yourSubscriptionStatus: 'Your Subscription Status',
    trialEnded: 'Trial Period Ended',
    trialEndedDescription: 'Your free trial has ended. To continue using the system, please subscribe to a plan. Your data is safely retained.',
    ...
    // Fee Descriptions
    licenseFeeDescription: 'One-time payment for software access',
    maintenanceFeeDescription: 'Recurring payment for support, updates, and hosting',
    totalFirstYear: 'Total (First Year)',
    thenRecurring: 'Then recurring',
    ...
    maintenanceUpcoming: 'Upcoming Maintenance',
    
    // Additional keys for pages
    maintenanceFeeStatus: 'Maintenance Fee Status',
    licenseFeeStatus: 'License Fee Status',
    submitMaintenancePayment: 'Submit your maintenance fee payment details',
    submitLicensePayment: 'Submit your license fee payment details',
    manageMaintenance: 'Manage Maintenance',
    paidOn: 'Paid on',
    lastPaid: 'Last paid',
    maintenanceInvoicesDescription: 'View and pay your maintenance invoices',
    noInvoices: 'No invoices found',
    noPaymentHistory: 'No payment history found',
    maintenancePaymentHistory: 'History of your maintenance fee payments',
    licensePaymentHistory: 'History of your license fee payments',
    licensePaidOn: 'License paid on',
    licensePaidAt: 'Paid At',
    licenseUnpaidDescription: 'You need to pay the license fee to access the software. Please submit your payment below.',
    licensePendingDescription: 'Your license payment is pending confirmation. Please wait for approval.',
    licensePaidDescription: 'Your license fee has been paid. Thank you!',
    maintenanceOverdueDescription: 'Your maintenance fee payment is overdue. Please pay immediately to avoid service interruption.',
    paymentReference: 'Payment Reference',
    paymentDate: 'Payment Date',
    paymentMethod: 'Payment Method',
    maintenancePaymentSubmitted: 'Maintenance payment submitted successfully',
    maintenancePaymentFailed: 'Failed to submit maintenance payment',
    licensePaymentSubmitted: 'License payment submitted successfully',
    licensePaymentFailed: 'Failed to submit license payment',
    pay: 'Pay',
    paymentHistory: 'Payment History',
    
    // Platform Admin Management Pages
    maintenanceFeesManagement: 'Maintenance Fees Management',
    maintenanceFeesManagementDescription: 'Manage maintenance fees across all organizations',
    licenseFeesManagement: 'License Fees Management',
    licenseFeesManagementDescription: 'Manage license fee payments across all organizations',
    totalMaintenanceFees: 'Total Organizations',
    overdueCount: 'Overdue',
    totalInvoices: 'Total Invoices',
    maintenanceFeesListDescription: 'List of all organizations with maintenance fees',
    invoicesListDescription: 'All generated maintenance invoices',
    noMaintenanceFees: 'No maintenance fees found',
    generateInvoicesDescription: 'Generate maintenance invoices for organizations with due dates',
    generateInvoicesWarning: 'This will generate invoices for all organizations with upcoming or overdue maintenance fees.',
    generate: 'Generate',
    invoicesGenerated: 'Invoices generated successfully',
    invoiceGenerationFailed: 'Failed to generate invoices',
    paymentConfirmed: 'Payment confirmed successfully',
    paymentConfirmFailed: 'Failed to confirm payment',
    overdueMaintenance: 'Overdue Maintenance Fees',
    overdueMaintenanceCount: '{count} organization(s) have overdue maintenance fees',
    current: 'Current',
    totalOrganizations: 'Total Organizations',
    unpaidCount: 'Unpaid',
    pendingCount: 'Pending',
    unpaidLicenseFees: 'Unpaid License Fees',
    unpaidLicenseFeesCount: '{count} organization(s) have not paid their license fees',
    licenseFees: 'License Fees',
    licenseFeesListDescription: 'List of all organizations with license fee status',
    noLicenseFees: 'No license fees found',
    maintenanceFees: 'Maintenance Fees',
    status: 'Status',
    viewLicenseHistory: 'View License History',
    viewMaintenanceInvoices: 'View Maintenance Invoices',
    noMaintenanceDue: 'No maintenance due at this time'
  },
