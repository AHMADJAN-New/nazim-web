...
export const en: TranslationKeys = {
  ...
  examTypes: {
    ...
    edit: 'Edit Exam Type',
    editDescription: 'Update exam type details',
    deleteConfirm: 'Are you sure you want to delete this exam type? This action cannot be undone.',
    namePlaceholder: 'e.g., Monthly, Final, Mid-Term',
    codePlaceholder: 'e.g., MONTHLY, FINAL, MID',
    descriptionPlaceholder: 'Optional description',
  },
  ...
  idCards: {
    ...
    description: 'Create and manage ID card templates for your organization',
    templates: 'Templates',
    createTemplate: 'Create Template',
    createTemplateDescription: 'Create a new ID card template with custom layout and styling.',
    editTemplate: 'Edit Template',
