export interface TranslationKeys {
  ...
  subscription: {
    ...
    trialEndsIn: string;
    trialEnding: string;
    // Trial ended (used on /subscription; also referenced by access gating UX)
    trialEnded: string;
    trialEndedDescription: string;
    ...
    // Subscription management page headings (used on /subscription)
    ...
    thenRecurring: string;
    
    // Payment Types
    paymentType: string;
    licensePayment: string;
    maintenancePayment: string;
