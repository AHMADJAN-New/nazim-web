...
export default {
  idCards: {
    ...
    alignSelected: "محاذاة المحدد",
    alignSelectedToStart: "محاذاة إلى البداية",
    alignSelectedToEnd: "محاذاة إلى النهاية",
    alignSelectedToTop: "محاذاة إلى الأعلى",
    alignSelectedToBottom: "محاذاة إلى الأسفل",
    distributeSelectedVertically: "توزيع عمودي",
    ctrlClickToSelectMultiple: "Ctrl+click (Cmd+click على Mac) لتحديد حقول متعددة، ثم محاذاتها.",
    assign: "Assign Cards",
    ...
    assignment: {
      ...
      showOnlyWithoutCard: "الطلاب الذين ليس لديهم بطاقة معينة فقط",
      noStudentsWithoutCard: "جميع الطلاب في هذه القائمة لديهم بطاقة بالفعل وفق المرشحات الحالية."
    },
