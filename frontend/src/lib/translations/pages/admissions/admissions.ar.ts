...
export default {
  admissions: {
    ...
    placementOrphaned: "تمت إزالة الشعبة — أعد التعيين",
    openInList: "فتح في القائمة",
    placementFilterAll: "كل التعيينات",
    placementFilterPlaced: "في الصف",
    placementFilterNeedsClass: "يحتاج صفاً",
    placementFilterOrphaned: "شعبة غير صالحة",
    placedInClass: "معيّن في الصف",
    placedInClassDescription: "قبولات نشطة بشعبة صف صالحة",
    needsClassAssignment: "يحتاج صفاً",
    needsClassDescription: "قبولات نشطة بدون شعبة صف صالحة",
    needsClassWithOrphaned: "يشمل {count} بشعب محذوفة",
