...
export const ErrorReportsManagement = lazy(() => import('@/platform/pages/admin/ErrorReportsManagement').then(module => ({ default: module.default })));
...
export const PlatformBackupsPage = lazy(() => import('@/platform/pages/admin/PlatformBackupsPage').then(module => ({ default: module.default })));
export const PlatformRestorePage = lazy(() => import('@/platform/pages/admin/PlatformRestorePage').then(module => ({ default: module.default })));
