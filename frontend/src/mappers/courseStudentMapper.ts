...
export const mapCourseStudentApiToDomain = (student: Api.CourseStudent): CourseStudent => ({
  ...
  tazkiraNumber: student.tazkira_number ?? null,
...
export const mapCourseStudentDomainToInsert = (student: Partial<CourseStudent>): Api.CourseStudentInsert => ({
  ...
  tazkira_number: toStr(student.tazkiraNumber),
  phone: toStr(student.phone),
  notes: toStr(student.notes),
...
export const mapCourseStudentDomainToUpdate = (
  ...
  tazkira_number: student.tazkiraNumber !== undefined ? toStr(student.tazkiraNumber) ?? undefined : undefined,
  phone: student.phone !== undefined ? toStr(student.phone) ?? undefined : undefined,
  notes: student.notes !== undefined ? toStr(student.notes) ?? undefined : undefined,
