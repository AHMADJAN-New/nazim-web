...
export const mapCourseStudentDomainToInsert = (student: Partial<CourseStudent>): Api.CourseStudentInsert => ({
  ...
  grandfather_name: student.grandfatherName ?? null,
  mother_name: student.motherName ?? null,
  gender: student.gender ?? null,
  birth_year: student.birthYear ?? null,
  birth_date: student.birthDate ?? null,
  age: student.age ?? null,
  orig_province: student.origProvince ?? null,
  orig_district: student.origDistrict ?? null,
  orig_village: student.origVillage ?? null,
  curr_province: student.currProvince ?? null,
  curr_district: student.currDistrict ?? null,
  curr_village: student.currVillage ?? null,
  nationality: student.nationality ?? null,
  preferred_language: student.preferredLanguage ?? null,
  ...
  is_orphan: student.isOrphan ?? null,
