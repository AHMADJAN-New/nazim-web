...
export function mapStudentAdmissionApiToDomain(api: StudentAdmissionApi.StudentAdmission): StudentAdmission {
  return {
    ...
    student: api.student ? {
      ...
      phone: api.student.phone || null,
      tazkiraNumber: api.student.tazkira_number || null,
      applyingGrade: api.student.applying_grade || null,
      nationality: api.student.nationality || null,
      origProvince: api.student.orig_province || null,
      origDistrict: api.student.orig_district || null,
      origVillage: api.student.orig_village || null,
      currProvince: api.student.curr_province || null,
      currDistrict: api.student.curr_district || null,
      currVillage: api.student.curr_village || null,
