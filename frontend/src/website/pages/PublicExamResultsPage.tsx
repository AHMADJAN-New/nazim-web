...
import { Search, Printer, AlertCircle, FileText, User } from 'lucide-react';
...
export default function PublicExamResultsPage() {
    ...
    const searchMutation = useMutation({
        mutationFn: async (data: { exam_id: string; search_term: string }) => {
    ...
    const handleSearch = (e: React.FormEvent) => {
        ...
        searchMutation.mutate({ exam_id: selectedExam, search_term: searchTerm });
    };
    ...
    return (
        <div className="flex-1 bg-slate-50 min-h-screen pb-20 print:bg-white print:pb-0">
            ...
            <section className="bg-emerald-900 text-white py-16 print:hidden">
                <div className="container mx-auto px-4 text-center">
                    <h1 className="text-3xl md:text-4xl font-bold mb-4">Check Exam Results</h1>
