...
export const useConfirmRollNumberAssignment = () => {
  ...
  return useMutation({
    ...
    onSuccess: (data: NumberAssignmentConfirmResponse) => {
      ...
      void queryClient.invalidateQueries({ queryKey: ['roll-number-report'] });
      void queryClient.invalidateQueries({ queryKey: ['roll-slips-html'] });
    },
    onError: (error: Error) => {
...
export const useConfirmSecretNumberAssignment = () => {
  ...
  return useMutation({
    ...
    onSuccess: (data: NumberAssignmentConfirmResponse) => {
      ...
      void queryClient.invalidateQueries({ queryKey: ['exam-students'] });
      void queryClient.invalidateQueries({ queryKey: ['roll-number-report'] });
      void queryClient.invalidateQueries({ queryKey: ['secret-labels-html'] });
    },
    onError: (error: Error) => {
