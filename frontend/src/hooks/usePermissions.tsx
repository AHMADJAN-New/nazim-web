...
const PERMISSION_TO_FEATURE_MAP: Record<string, string | string[]> = {
  ...
  'hr_staff.read': 'org_hr_core',
  'hr_staff.create': 'org_hr_core',
  'hr_staff.update': 'org_hr_core',
  'hr_staff.delete': 'org_hr_core',
  ...
  'hr_payroll.run': 'org_hr_payroll',
  'hr_payroll.approve': 'org_hr_payroll',
  ...
  'exam_seating_maps.read': 'exams_full',
  'exam_seating_maps.create': 'exams_full',
  'exam_seating_maps.update': 'exams_full',
  'exam_seating_maps.delete': 'exams_full',
  'exam_seating_maps.assign': 'exams_full',
  'exam_seating_maps.print': 'exams_full',
