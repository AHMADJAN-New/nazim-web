...
### `pages/academic/academic.ar.ts` (AR)

| Key | Value |
|-----|-------|
| `academic.academicInformation` | Academic information |
| `academic.academicYears.academicYear` | Academic Year |
| `academic.classes.classes` | Classes |
| `academic.scheduleSlots.allDays` | All Days |
| `academic.scheduleSlots.anyDay` | Any Day |
| `academic.scheduleSlots.createSlot` | Create a new time range for scheduling |
| `academic.scheduleSlots.organizationWide` | Organization-wide |
| `academic.scheduleSlots.timeRange` | Time Range |
| `academic.scheduleSlots.updateSlot` | Update the schedule slot details |
| `academic.staffTypes.active` | Active |
| `academic.staffTypes.addStaffType` | Add Staff Type |
| `academic.staffTypes.code` | Code |
| `academic.staffTypes.createStaffType` | Create a new staff type |
| `academic.staffTypes.deleteConfirm` | Are you sure you want to delete this staff type? This action cannot be undone. |
| `academic.staffTypes.description` | Description |
| `academic.staffTypes.displayOrder` | Display Order |
| `academic.staffTypes.editStaffType` | Edit Staff Type |
| `academic.staffTypes.inactive` | Inactive |
| `academic.staffTypes.isActive` | Active Status |
| `academic.staffTypes.management` | Staff Types Management |
| `academic.staffTypes.name` | Name |
| `academic.staffTypes.noStaffTypesFound` | No staff types found |
| `academic.staffTypes.noStaffTypesMessage` | No staff types available |
| `academic.staffTypes.searchPlaceholder` | Search staff types... |
| `academic.staffTypes.title` | Staff Types Management |
| `academic.staffTypes.updateStaffType` | Update staff type information |
| `academic.subjects.subject` | Subject |
| `academic.subjects.subjects` | Subjects |
| `academic.timetable.day` | Friday |
| `academic.timetable.period` | Period |
| `academic.timetable.subject` | Subject |
| `academic.timetable.time` | Time |

### `pages/admissions/admissions.ar.ts` (AR)

| Key | Value |
|-----|-------|
| `admissions.additionalInfo` | Additional |
| `admissions.admissionNumber` | Admission # |
| `admissions.basicInfo` | Basic Info |
| `admissions.bulkDeactivate` | Bulk deactivate |
| `admissions.bulkDeactivateDescription` | Bulk deactivate description |
| `admissions.bulkDeactivateTitle` | Deactivate Student Admissions |
| `admissions.deactivate` | Deactivate |
| `admissions.exportFailed` | Failed to generate PDF report |
| `admissions.noClassesAssignedToYear` | No classes have been assigned to this academic year yet |
| `admissions.noClassesForYear` | No classes available for this academic year |
| `admissions.noRoomsFound` | No rooms found. |
| `admissions.noStudentsFound` | No students found. |
| `admissions.reportExported` | PDF report generated successfully |
| `admissions.residencyInfo` | Residency |
| `admissions.schoolRequiredForExport` | A school is required to export the report. |
| `admissions.schoolSwitched` | School switched successfully |
| `admissions.searchRoom` | Search rooms... |
| `admissions.searchStudent` | Search by name or admission number... |
...
| Key | Value |
|-----|-------|
| `assets.assetsByCategory` | Assets by Category |
| `assets.assetsByFinanceAccount` | Assets by Finance Account |
| `assets.assignedAssets` | Assigned Assets |
| `assets.dashboard` | Assets Dashboard |
| `assets.dashboardDescription` | Overview of your organization |
| `assets.inMaintenance` | In Maintenance |
| `assets.items` | items |
| `assets.linkedToAccounts` | Assets linked to finance accounts |
| `assets.noAssignments` | No recent assignments |
| `assets.recentAssignments` | recent assignments |
| `assets.requiresAttention` | Requires attention |
| `assets.statusBreakdown` | Status Breakdown |
| `assets.totalAssets` | Total Assets |
| `assets.totalAssetsDescription` | Total assets in inventory |
...
| `attendance.closed` | Closed |
| `attendance.latestAttendanceSessions` | Latest attendance sessions |
| `attendance.noSessions` | No attendance sessions found |
...
| `attendancePage.noScansMatchSearch` | No scans match your search |
| `attendancePage.noStudentsMatchSearch` | No students match your search |
| `attendancePage.searchRosterPlaceholder` | Search by name, admission, card, or code... |
| `attendancePage.searchScans` | Search scans... |
| `attendancePage.selectAtLeastOneClass` | Select at least one class |
| `attendanceReports.generatingReport` | Generating Report |
| `attendanceReports.noRecordsToExport` | No records to export |
| `attendanceReports.reportExported` | Report generated successfully |
| `attendanceReports.reportFailed` | Report generation failed. |
| `attendanceReports.reportGenerationFailed` | Failed to check report status |
| `attendanceReports.reportInProgress` | Please wait while the report is being generated... |
| `attendanceReports.reportReady` | Report is ready! |
| `attendanceReports.reportStatus` | Report status |
| `attendanceReports.schoolRequired` | School is required for report generation |
| `attendanceTotalsReport.generalRoom` | General Room |
| `attendanceTotalsReport.generatingReport` | Generating Report |
| `attendanceTotalsReport.noRecentRoomSessions` | No room sessions found for this range. |
| `attendanceTotalsReport.recentRoomSessions` | Recent room attendance sessions |
| `attendanceTotalsReport.recentRoomSessionsHint` | Latest room sessions within the selected date range. |
| `attendanceTotalsReport.reportExported` | Report generated successfully |
| `attendanceTotalsReport.reportFailed` | Report generation failed. |
| `attendanceTotalsReport.reportGenerationFailed` | Failed to check report status |
| `attendanceTotalsReport.reportInProgress` | Please wait while the report is being generated... |
| `attendanceTotalsReport.reportReady` | Report is ready! |
| `attendanceTotalsReport.reportStatus` | Report status |
...
| `auth.noOrganizationsFound` | No organizations found. Please contact an administrator. |
| `auth.organization` | Organization |
| `auth.password` | Password |
| `auth.phone` | Phone |
| `auth.signInFailed` | Sign in failed. Please try again. |
| `auth.subtitle` | Access your school management system |
| `auth.title` | School Management System |

### `pages/certificates/certificates.ar.ts` (AR)

| Key | Value |
|-----|-------|
| `certificates.noIssuedCertificates` | Certificates |
| `certificates.templateRequired` | Certificates |
| `certificateTemplates.certificateNumber` | Certificate Number |
| `certificateTemplates.hasBackgroundImage` | Has Background Image |
| `certificateTemplates.selectTemplatePlaceholder` | Choose a certificate template... |

### `pages/courses/courses.ar.ts` (AR)
...
| `courses.csv` | CSV |
| `courses.currentlyEnrolled` | Currently enrolled |
| `courses.documents` | Documents |
| `courses.dropRate` | Drop rate |
| `courses.manageDocuments` | Manage documents |
| `courses.pdf` | PDF |
...
| Key | Value |
|-----|-------|
| `dashboard.activeStaff` | Assets Dashboard |
| `dashboard.activeStudents` | Assets Dashboard |
| `dashboard.availableRooms` | Assets Dashboard |
| `dashboard.buildings` | Assets Dashboard |
| `dashboard.genderDistribution` | Assets Dashboard |
| `dashboard.overview` | Assets Dashboard |
| `dashboard.schoolBuildings` | Assets Dashboard |
| `dashboard.totalBuildings` | Assets Dashboard |
| `dashboard.totalClasses` | Assets Dashboard |
| `dashboard.viewTabsForDetails` | Assets Dashboard |
| `dashboard.welcomeBack` | Assets Dashboard |
| `dashboard.welcomeMessage` | Assets Dashboard |

### `pages/dms/dms.ar.ts` (AR)

| Key | Value |
|-----|-------|
| `dms.deleteDocumentWarning` | Are you sure you want to delete this outgoing document? This action cannot be... |
| `dms.fields.academic_info` | Academic_info |
| `dms.fields.application_info` | Application_info |
| `dms.fields.available_fields` | Available_fields |
| `dms.fields.basic_info` | Basic_info |
| `dms.fields.common_fields` | Common_fields |
| `dms.fields.contact_info` | Contact_info |
| `dms.fields.custom_fields` | Custom_fields |
| `dms.fields.datetime_info` | Datetime_info |
| `dms.fields.document_info` | Document_info |
| `dms.fields.education_info` | Education_info |
| `dms.fields.employment_info` | Employment_info |
| `dms.fields.guardian_info` | Guardian_info |
| `dms.fields.insert_field` | Insert_field |
| `dms.fields.insert_field_help` | Insert_field_help |
| `dms.fields.insert_field_placeholder` | Insert_field_placeholder |
| `dms.fields.inserted` | Inserted |
| `dms.fields.no_fields_found` | No_fields_found |
| `dms.fields.organization_info` | Organization_info |
| `dms.fields.recipient_info` | Recipient_info |
| `dms.fields.search_fields` | Search_fields |
| `dms.fields.select_field` | Select_field |
| `dms.issueLetter.downloadImage` | Download Image |
| `dms.issueLetter.letterDetails.downloadImage` | Download Image |
| `dms.issueLetter.downloadPdf` | download Pdf |
| `dms.letterTypesPage.createDialog.keyPlaceholder` | مثال: application, moe_letter |
| `dms.reportsPage.notAvailable` | N/A |
| `dms.templatesForm.fontSizeSuffix` | px |
| `dms.letterheadForm.fileTypesHint` | PDF, JPG, PNG, WEBP (حد أقصى 10MB) |

### `pages/dms/dms.fa.ts` (FA)
...
### `pages/exams/exams.ar.ts` (AR)

| Key | Value |
|-----|-------|
| `examPaperPreview.academicYear` | Year |
| `examPaperPreview.answerHere` | Write your answer here |
| `examPaperPreview.duration` | Duration |
| `examPaperPreview.instructions` | Instructions |
| `examPaperPreview.marks` | marks |
| `examPaperPreview.minutes` | min |
| `examPaperPreview.modelAnswer` | Model Answer |
| `examPaperPreview.questions` | questions |
| `examPaperPreview.reference` | Reference |
| `examPaperPreview.sections` | Sections |
| `examPaperPreview.studentName` | Student Name |
| `examPaperPreview.studentView` | Student |
| `examPaperPreview.subject` | Subject |
| `examPaperPreview.teacherView` | Teacher |
| `examPaperPreview.totalMarks` | Total Marks |
| `examPaperPreview.totalQuestions` | Total Questions |
| `examPapers.academicYear` | Academic Year |
| `examPapers.classAcademicYear` | Class |
| `examPapers.copiesPrinted` | Copies Printed |
| `examPapers.createDescription` | Create a new exam paper template |
| `examPapers.createPaper` | Create Exam Paper |
| `examPapers.createTemplate` | Create Template |
| `examPapers.defaultForExamSubject` | Default for Exam Subject |
| `examPapers.deleteConfirmMessage` | Are you sure you want to delete this template? This action cannot be undone. |
| `examPapers.difficulty` | Difficulty |
| `examPapers.duration` | Duration (minutes) |
| `examPapers.editDescription` | Update the template details |
| `examPapers.editPaper` | Edit Exam Paper |
| `examPapers.editQuestions` | Edit Questions |
| `examPapers.editTemplate` | Edit Template |
| `examPapers.exam` | Exam |
| `examPapers.filterExam` | Exam |
| `examPapers.filterPrintStatus` | Print Status |
| `examPapers.footerHtml` | Footer HTML |
| `examPapers.footerHtmlPlaceholder` | Custom footer HTML... |
| `examPapers.generatePdf` | Generate PDF |
| `examPapers.generic` | Generic |
| `examPapers.genericTemplate` | Generic Template (no exam) |
| `examPapers.headerHtml` | Header HTML |
| `examPapers.headerHtmlPlaceholder` | Custom header HTML... |
| `examPapers.instructions` | Instructions |
| `examPapers.instructionsPlaceholder` | Instructions for students... |
| `examPapers.language` | Language |
| `examPapers.lastPrinted` | Last Printed |
| `examPapers.marks` | Marks |
| `examPapers.noPapers` | No papers found |
| `examPapers.noPapersFound` | No papers found. Create your first exam paper to get started. |
| `examPapers.noTemplates` | No templates found |
| `examPapers.noTemplatesFound` | No templates found. Create your first template to get started. |
| `examPapers.paperDetails` | Paper Details |
| `examPapers.paperDetailsDescription` | View detailed information about the exam paper |
| `examPapers.papersList` | Exam Papers |
| `examPapers.paperTitle` | Title |
| `examPapers.printConfirmation` | Print Confirmation |
| `examPapers.printConfirmationDescription` | How many copies were printed? |
| `examPapers.printedBy` | Printed By |
| `examPapers.printNotes` | Print Notes |
| `examPapers.printStatus` | Print Status |
| `examPapers.printStatusUpdated` | Print status updated successfully |
| `examPapers.printStatusUpdateFailed` | Failed to update print status |
| `examPapers.printTracking` | Exam Paper Print Tracking |
| `examPapers.printTrackingDescription` | Track print status and copies printed for exam papers |
| `examPapers.question` | Question |
| `examPapers.questions` | Questions |
| `examPapers.school` | School |
| `examPapers.selectAcademicYear` | Select academic year |
| `examPapers.selectAcademicYearFirst` | Select academic year first |
| `examPapers.selectExam` | Select exam (optional) |
| `examPapers.selectSubject` | Select subject |
| `examPapers.selectTemplateFile` | Select template file (optional) |
| `examPapers.subject` | Subject |
| `examPapers.subjectsForClass` | Showing subjects for selected class |
| `examPapers.templateFile` | Template File (Optional) |
| `examPapers.templateFileHelp` | Select a custom template file or use the default template for this language |
| `examPapers.templateTitle` | Title |
| `examPapers.titlePlaceholder` | e.g., Mathematics Final Exam Paper |
| `examPapers.totalMarks` | Total Marks |
| `examPapers.totalMarksPlaceholder` | Auto-calculated from questions |
| `examPapers.totalPapers` | Total papers |
| `examPapers.useDefaultTemplate` | Use Default Template |
| `examReports.academicYear` | Exam Reports |
| `examReports.classAverage` | Exam Reports |
| `examReports.className` | Exam Reports |
| `examReports.classSubjectMarkSheetDescription` | Exam Reports |
| `examReports.consolidatedMarkSheetDescription` | Exam Reports |
| `examReports.consolidatedReport` | Exam Reports |
| `examReports.examName` | Exam Reports |
| `examReports.exportMultipleClasses` | Exam Reports |
| `examReports.exportMultipleClassesDescription` | Exam Reports |
| `examReports.multipleClasses` | Exam Reports |
| `examReports.multipleSubjects` | Exam Reports |
| `examReports.multipleSubjectsDescription` | Exam Reports |
| `examReports.noMarksEntered` | Exam Reports |
| `examReports.obtainedMarks` | Exam Reports |
| `examReports.passingMarks` | Exam Reports |
| `examReports.passPercentage` | Exam Reports |
| `examReports.selectClassPrompt` | Exam Reports |
| `exams.addClass` | Exams |
| `exams.addClassDescription` | Exams |
| `exams.addClassesFirst` | Exams |
| `exams.addSubject` | Exams |
| `exams.addSubjectDescription` | Exams |
| `exams.addTimeSlot` | Exams |
| `exams.addTimeSlotDescription` | Exams |
| `exams.allConfigured` | Exams |
| `exams.allStudentsEnrolled` | Exams |
| `exams.assignedClassesDescription` | Exams |
| `exams.attendance.barcode` | Exams |
| `exams.attendance.confirmUnlock` | Exams |
| `exams.attendance.focusScanner` | Exams |
| `exams.attendance.locked` | Exams |
| `exams.attendance.manual` | Exams |
| `exams.attendance.markAttendance` | Exams |
| `exams.attendance.multiSlotHint` | Exams |
| `exams.attendance.noScansMatch` | Exams |
| `exams.attendance.noScansYet` | Exams |
| `exams.attendance.note` | Exams |
| `exams.attendance.recordScan` | Exams |
| `exams.attendance.scanFeed` | Exams |
| `exams.attendance.scanning` | Exams |
| `exams.attendance.scanRollNumber` | Exams |
| `exams.attendance.searchScans` | Exams |
| `exams.attendance.seatNumber` | Exams |
| `exams.attendance.selectedSlots` | Exams |
| `exams.attendance.selectTimeslot` | Exams |
| `exams.attendance.selectTimeslotPrompt` | Exams |
| `exams.attendance.selectTimeSlots` | Exams |
| `exams.attendance.status` | Exams |
| `exams.attendance.time` | Exams |
| `exams.attendance.timeSlot` | Exams |
| `exams.attendance.title` | Exams |
| `exams.attendance.unlock` | Exams |
| `exams.attendance.unlockAttendance` | Exams |
| `exams.attendance.unlockExamMessage` | Exams |
| `exams.attendance.unlockMessage` | Exams |
| `exams.backToList` | Exams |
| `exams.changeStatus` | Exams |
| `exams.changeStatusConfirm` | Exams |
| `exams.changeStatusConfirmMessage` | Exams |
| `exams.classesAssigned` | Exams |
| `exams.classesConfigured` | Exams |
| `exams.classesSubjects` | Exams |
| `exams.classesSubjectsDescription` | Exams |
| `exams.complete` | Exams |
| `exams.deleteTimeSlotConfirm` | Exams |
| `exams.deleteTimeSlotConfirmMessage` | Exams |
| `exams.editSubject` | Exams |
| `exams.editSubjectDescription` | Exams |
| `exams.editTimeSlot` | Exams |
| `exams.editTimeSlotDescription` | Exams |
| `exams.endTime` | Exams |
| `exams.enrollAllClasses` | Exams |
| `exams.enrollmentStatus` | Exams |
| `exams.enrollmentStatusDescription` | Exams |
| `exams.entered` | Exams |
| `exams.examType` | Exams |
| `exams.failed` | Exams |
| `exams.filterByClass` | Exams |
| `exams.filterByExamType` | Exams |
| `exams.incomplete` | Exams |
| `exams.invalidTimeRange` | Exams |
| `exams.invigilator` | Exams |
| `exams.locked` | Locked |
| `exams.marks` | Exams |
| `exams.marksDescription` | Exams |
| `exams.marksEntry` | Exams |
| `exams.marksEntryProgress` | Exams |
| `exams.marksEntryProgressDescription` | Exams |
| `exams.noAvailableClasses` | Exams |
| `exams.noAvailableSubjects` | Exams |
| `exams.noEnrollmentData` | Exams |
| `exams.noExamsAvailable` | Exams |
| `exams.noExamsFiltered` | Exams |
| `exams.noMarksData` | Exams |
| `exams.noStudentsHint1` | Exams |
| `exams.noStudentsHint2` | Exams |
| `exams.noStudentsHint3` | Exams |
| `exams.noSubjectsConfigured` | Exams |
| `exams.notes` | Exams |
| `exams.notesPlaceholder` | Exams |
| `exams.noTimeSlots` | Exams |
| `exams.numberReports.classBreakdown` | Exams |
| `exams.numberReports.complete` | Exams |
| `exams.numberReports.description` | Exams |
| `exams.numberReports.errorLoadingPreview` | Exams |
| `exams.numberReports.errorLoadingPreviewDescription` | Exams |
| `exams.numberReports.exportCsv` | Exams |
| `exams.numberReports.filter` | Exams |
| `exams.numberReports.filterDescription` | Exams |
| `exams.numberReports.noStudents` | Exams |
| `exams.numberReports.printPreviewDescription` | Exams |
| `exams.numberReports.printRollSlips` | Exams |
| `exams.numberReports.printSecretLabels` | Exams |
| `exams.numberReports.progress` | Exams |
| `exams.numberReports.rollNumberList` | Exams |
| `exams.numberReports.rollNumberSummary` | Exams |
| `exams.numberReports.rollSlipsPreview` | Exams |
| `exams.numberReports.secretLabelsPreview` | Exams |
| `exams.numberReports.secretNumberSummary` | Exams |
| `exams.numberReports.students` | Exams |
| `exams.numberReports.summary` | Exams |
| `exams.numberReports.title` | Exams |
| `exams.numberReports.totalStudents` | Exams |
| `exams.numberReports.withoutRollNumber` | Exams |
| `exams.numberReports.withoutSecretNumber` | Exams |
| `exams.numberReports.withRollNumber` | Exams |
| `exams.numberReports.withSecretNumber` | Exams |
| `exams.overallEnrollment` | Exams |
| `exams.overallProgress` | Exams |
| `exams.passed` | Exams |
| `exams.pendingConfiguration` | Exams |
| `exams.percentage` | Exams |
| `exams.period` | Exams |
| `exams.possibleReasons` | Exams |
| `exams.removeClassConfirm` | Exams |
| `exams.removeClassConfirmMessage` | Exams |
| `exams.removeSubjectConfirm` | Exams |
| `exams.removeSubjectConfirmMessage` | Exams |
| `exams.reportsDescription` | Exams |
| `exams.results` | Exams |
| `exams.resultsEntered` | Exams |
| `exams.rollNumbers.andMore` | Exams |
| `exams.rollNumbers.assigned` | Exams |
| `exams.rollNumbers.autoAssign` | Exams |
| `exams.rollNumbers.autoAssignDescription` | Exams |
| `exams.rollNumbers.collision` | Exams |
| `exams.rollNumbers.confirmAssign` | Exams |
| `exams.rollNumbers.confirmOverride` | Exams |
| `exams.rollNumbers.confirmOverrideButton` | Exams |
| `exams.rollNumbers.confirmOverrideDescription` | Exams |
| `exams.rollNumbers.current` | Exams |
| `exams.rollNumbers.description` | Exams |
| `exams.rollNumbers.entireExam` | Exams |
| `exams.rollNumbers.missing` | Exams |
| `exams.rollNumbers.new` | Exams |
| `exams.rollNumbers.noStudents` | Exams |
| `exams.rollNumbers.notAssigned` | Exams |
| `exams.rollNumbers.options` | Exams |
| `exams.rollNumbers.override` | Exams |
| `exams.rollNumbers.overrideExisting` | Exams |
| `exams.rollNumbers.previewAssignment` | Exams |
| `exams.rollNumbers.previewDescription` | Exams |
| `exams.rollNumbers.previewTitle` | Exams |
| `exams.rollNumbers.progress` | Exams |
| `exams.rollNumbers.rollNumber` | Exams |
| `exams.rollNumbers.scope` | Exams |
| `exams.rollNumbers.selectedClass` | Exams |
| `exams.rollNumbers.startFrom` | Exams |
| `exams.rollNumbers.studentList` | Exams |
| `exams.rollNumbers.title` | Exams |
| `exams.rollNumbers.toAssign` | Exams |
| `exams.rollNumbers.totalStudents` | Exams |
| `exams.rollNumbers.useSuggested` | Exams |
| `exams.rollNumbers.willOverride` | Exams |
| `exams.room` | Exams |
| `exams.secretNumbers.andMore` | Exams |
| `exams.secretNumbers.assigned` | Exams |
| `exams.secretNumbers.autoAssign` | Exams |
| `exams.secretNumbers.autoAssignDescription` | Exams |
| `exams.secretNumbers.collision` | Exams |
| `exams.secretNumbers.confirmAssign` | Exams |
| `exams.secretNumbers.confirmOverride` | Exams |
| `exams.secretNumbers.confirmOverrideButton` | Exams |
| `exams.secretNumbers.confirmOverrideDescription` | Exams |
| `exams.secretNumbers.current` | Exams |
| `exams.secretNumbers.description` | Exams |
| `exams.secretNumbers.enterSecretNumber` | Exams |
| `exams.secretNumbers.entireExam` | Exams |
| `exams.secretNumbers.hide` | Exams |
| `exams.secretNumbers.lookup` | Exams |
| `exams.secretNumbers.lookupButton` | Exams |
| `exams.secretNumbers.lookupDescription` | Exams |
| `exams.secretNumbers.lookupResult` | Exams |
| `exams.secretNumbers.missing` | Exams |
| `exams.secretNumbers.new` | Exams |
| `exams.secretNumbers.noStudents` | Exams |
| `exams.secretNumbers.notAssigned` | Exams |
| `exams.secretNumbers.notFound` | Exams |
| `exams.secretNumbers.options` | Exams |
| `exams.secretNumbers.override` | Exams |
| `exams.secretNumbers.overrideExisting` | Exams |
| `exams.secretNumbers.previewAssignment` | Exams |
| `exams.secretNumbers.previewDescription` | Exams |
| `exams.secretNumbers.previewTitle` | Exams |
| `exams.secretNumbers.progress` | Exams |
| `exams.secretNumbers.scope` | Exams |
| `exams.secretNumbers.secretNumber` | Exams |
| `exams.secretNumbers.selectedClass` | Exams |
| `exams.secretNumbers.show` | Exams |
| `exams.secretNumbers.startFrom` | Exams |
| `exams.secretNumbers.studentList` | Exams |
| `exams.secretNumbers.title` | Exams |
| `exams.secretNumbers.toAssign` | Exams |
| `exams.secretNumbers.totalStudents` | Exams |
| `exams.secretNumbers.useSuggested` | Exams |
| `exams.secretNumbers.willOverride` | Exams |
| `exams.selectClassPlaceholder` | Exams |
| `exams.selectExamDescription` | Exams |
| `exams.selectExamPlaceholder` | Exams |
| `exams.selectExamToStart` | Exams |
| `exams.selectExamToViewTimetable` | Exams |
| `exams.selectExamType` | Exams |
| `exams.selectInvigilator` | Exams |
| `exams.selectRoom` | Exams |
| `exams.selectSubjectPlaceholder` | Exams |
| `exams.selectTimeSlot` | Exams |
| `exams.sessions` | Exams |
| `exams.startTime` | Exams |
| `exams.statistics` | Exams |
| `exams.status.archived` | Exams |
| `exams.status.completed` | Exams |
| `exams.status.draft` | Exams |
| `exams.status.in_progress` | Exams |
| `exams.status.scheduled` | Exams |
| `exams.studentCode` | Exams |
| `exams.studentName` | Exams |
| `exams.subject` | Exams |
| `exams.time` | Time |
| `exams.timeSlot` | Time Slot |
| `exams.timetable` | Exams |
| `exams.timetableDescription` | Exams |
| `exams.total` | Exams |
| `exams.totalClasses` | Exams |
| `exams.totalSubjects` | Exams |
| `exams.unlocked` | Exams |
| `exams.unlock` | unlock |
| `exams.lock` | lock |
| `examTypes.codePlaceholder` | e.g., MONTHLY, FINAL, MID |
| `examTypes.createDescription` | Create a new exam for an academic year |
| `examTypes.editDescription` | Update exam details |
| `examTypes.isActive` | Active |
| `examTypes.namePlaceholder` | e.g., Midterm Exam |

### `pages/exams/exams.fa.ts` (FA)
...
| Key | Value |
|-----|-------|
| `fees.accountRequired` | Fees |
| `fees.activeExceptions` | Fees |
| `fees.adjustedTotal` | Fees |
| `fees.afterException` | Fees |
| `fees.allStatuses` | Fees |
| `fees.allStudentFees` | Fees |
| `fees.amountRequired` | Fees |
| `fees.approvedAt` | Fees |
| `fees.approvedBy` | Fees |
| `fees.assigned` | Fees |
| `fees.assignedAmount` | Fees |
| `fees.assignedClasses` | Fees |
| `fees.assignmentDetails` | Fees |
| `fees.assignmentInformation` | Fees |
| `fees.assignmentRequired` | Fees |
| `fees.assignmentStatus` | Fees |
| `fees.averageCollectionRate` | Fees |
| `fees.className` | Fees |
| `fees.classWiseSummary` | Fees |
| `fees.classWiseSummaryDescription` | Fees |
| `fees.codePlaceholder` | مثال: G1_MONTHLY |
| `fees.collected` | Fees |
| `fees.collectionByClass` | Fees |
| `fees.collectionProgress` | Fees |
| `fees.collectionRate` | Fees |
| `fees.confirmDeleteException` | Fees |
| `fees.current` | Fees |
| `fees.currentFeeOriginal` | Fees |
| `fees.currentUserWillBeApprover` | Fees |
| `fees.dashboard` | Fees |
| `fees.dashboardDescription` | Fees |
| `fees.deleteAssignmentConfirm` | Fees |
| `fees.editAssignment` | Fees |
| `fees.editException` | Fees |
| `fees.exception` | Fees |
| `fees.exceptionBreakdown` | Fees |
| `fees.exceptionDetails` | Fees |
| `fees.exceptionDetailsDescription` | Fees |
| `fees.exceptionReduction` | Fees |
| `fees.exceptionsSummary` | Fees |
| `fees.feeStructure` | Fees |
| `fees.financialDetails` | Fees |
| `fees.financialSummary` | Fees |
| `fees.fullyPaid` | Fees |
| `fees.isActive` | Fees |
| `fees.isActiveDescription` | Fees |
| `fees.manageFees` | Fees |
| `fees.noAssignmentsAvailable` | Fees |
| `fees.noClassData` | Fees |
| `fees.noExceptions` | Fees |
| `fees.noRecentPayments` | Fees |
| `fees.notPaid` | Fees |
| `fees.ofTotalAssigned` | Fees |
| `fees.originalAmount` | Fees |
| `fees.originalTotal` | Fees |
| `fees.otherFees` | Fees |
| `fees.overdue` | Fees |
| `fees.paidAmount` | Fees |
| `fees.partiallyPaid` | Fees |
| `fees.paymentDateRequired` | Fees |
| `fees.paymentDetails` | Fees |
| `fees.paymentDetailsDescription` | Fees |
| `fees.paymentInformation` | Fees |
| `fees.recentPayments` | Fees |
| `fees.recordPaymentDescription` | Fees |
| `fees.reduction` | Fees |
| `fees.reports` | Fees |
| `fees.reportsDescription` | Fees |
| `fees.school` | Fees |
| `fees.selectAcademicYearAndClass` | Fees |
| `fees.selectAcademicYearFirst` | Fees |
| `fees.selectClassAndAcademicYearFirst` | Fees |
| `fees.statusAndDates` | Fees |
| `fees.statusDistribution` | Fees |
| `fees.structureDetails` | Fees |
| `fees.studentFeeAssignments` | Fees |
| `fees.studentFeeStatus` | Fees |
| `fees.studentName` | Fees |
| `fees.students` | Fees |
| `fees.studentWiseSummary` | Fees |
| `fees.studentWiseSummaryDescription` | Fees |
| `fees.summary` | Fees |
| `fees.totalAssigned` | Fees |
| `fees.totalClasses` | Fees |
| `fees.totalFee` | Fees |
| `fees.totalPaid` | Fees |
| `fees.totalPayable` | Fees |
| `fees.totalRemaining` | Fees |
| `fees.totalValue` | Fees |
| `fees.viewAllExceptions` | Fees |
| `fees.viewAssignmentDetails` | Fees |
| `fees.viewAssignments` | Fees |
...
| Key | Value |
|-----|-------|
| `grades.createDescription` | Create description |
| `grades.editDescription` | Edit description |
| `grades.managementDescription` | Management description |
| `grades.maxPercentagePlaceholder` | Max percentage placeholder |
| `grades.minPercentagePlaceholder` | Min percentage placeholder |
| `grades.nameArPlaceholder` | Name ar placeholder |
| `grades.nameEnPlaceholder` | Name en placeholder |
| `grades.nameFaPlaceholder` | Name fa placeholder |
| `grades.namePsPlaceholder` | Name ps placeholder |
| `grades.noGradesDescription` | No grades description |
| `grades.orderPlaceholder` | Order placeholder |

### `pages/graduation/graduation.ar.ts` (AR)
...
| Key | Value |
|-----|-------|
| `hostel.boarders` | Boarders |
| `hostel.boardersLabel` | boarders |
| `hostel.export` | Export |
| `hostel.occupied` | occupied |
| `hostel.reports.admissionNumberColumn` | Reports |
| `hostel.reports.admissionYearColumn` | Reports |
| `hostel.reports.assignedBoarders` | Reports |
| `hostel.reports.assignedBoardersDescription` | Reports |
| `hostel.reports.assignedBoardersTitle` | Reports |
| `hostel.reports.boardersAssigned` | Reports |
| `hostel.reports.boardersColumn` | Reports |
| `hostel.reports.buildingColumn` | Reports |
| `hostel.reports.buildings` | Reports |
| `hostel.reports.buildingsColumn` | Reports |
| `hostel.reports.buildingUtilization` | Reports |
| `hostel.reports.buildingUtilizationDescription` | Reports |
| `hostel.reports.classColumn` | Reports |
| `hostel.reports.hostelReporting` | Reports |
| `hostel.reports.loadingHostelReports` | Reports |
| `hostel.reports.monitorUtilization` | Reports |
| `hostel.reports.occupiedColumn` | Reports |
| `hostel.reports.occupiedRooms` | Reports |
| `hostel.reports.preparingReportData` | Reports |
| `hostel.reports.residencyTypeColumn` | Reports |
| `hostel.reports.roomAndBuildingsDescription` | Reports |
| `hostel.reports.roomAndBuildingsTitle` | Reports |
| `hostel.reports.roomLabel` | Reports |
| `hostel.reports.rooms` | Reports |
| `hostel.reports.roomsColumn` | Reports |
| `hostel.reports.roomsWithWardens` | Reports |
| `hostel.reports.student` | Reports |
| `hostel.reports.students` | Reports |
| `hostel.reports.studentsLabel` | Reports |
| `hostel.reports.unassignedBoarders` | Reports |
| `hostel.reports.unassignedBoardersDescription` | Reports |
| `hostel.reports.unassignedBoardersTitle` | Reports |
| `hostel.reports.utilizationColumn` | Reports |
| `hostel.reports.wardenCoverage` | Reports |
| `hostel.reports.wardenCoverageDescription` | Reports |
| `hostel.reports.wardenName` | Reports |
| `hostel.reports.occupiedOfTotal` | {occupied} من {total} |
| `hostel.overview` | overview |

### `pages/hostel/hostel.fa.ts` (FA)
...
| Key | Value |
|-----|-------|
| `idCards.accountAndCategoryRequired` | Account and Income Category are required when fee is paid |
| `idCards.active` | Active |
| `idCards.admissionNumber` | Admission Number |
| `idCards.assign` | Assign Cards |
| `idCards.assigned` | Assigned |
| `idCards.assignedAt` | Assigned At |
| `idCards.auto` | Auto (based on base size) |
| `idCards.autoBasedOnGlobal` | Auto (based on global) |
| `idCards.background` | Background |
| `idCards.backgroundBack` | Background Image (Back) |
| `idCards.backgroundFront` | Background Image (Front) |
| `idCards.backgroundNotAvailable` | Background image not available |
| `idCards.backPreview` | Back Preview |
| `idCards.backSide` | Back Side |
| `idCards.both` | Both Sides |
| `idCards.cardFee` | Card Fee |
| `idCards.clickPreviewToGenerate` | Click Preview button to generate card image |
| `idCards.created` | Created |
| `idCards.createFirstTemplate` | Create Your First Template |
| `idCards.createTemplateDescription` | Create a new ID card template with custom layout and styling. |
| `idCards.currentImageKept` | Current image will be kept |
| `idCards.deleteConfirmation` | Are you sure you want to delete this ID card template? This action cannot be ... |
| `idCards.downloadFailed` | Download failed |
| `idCards.downloadSuccess` | Download success |
| `idCards.editCard` | Edit ID Card |
| `idCards.editLayoutDescription` | Customize the layout, positioning, and styling of ID card elements. Drag elem... |
| `idCards.editTemplateDescription` | Update the ID card template settings and configuration. |
| `idCards.expiryDateDescription` | Set a fixed expiry date, or leave empty to use dynamic date (1 year from prin... |
| `idCards.expiryDateValue` | Expiry Date |
| `idCards.export.cardsPerPage` | ID Card Export |
| `idCards.export.description` | ID Card Export |
| `idCards.export.exportAll` | ID Card Export |
| `idCards.export.exportSelected` | ID Card Export |
| `idCards.export.format` | ID Card Export |
| `idCards.export.includeUnpaid` | ID Card Export |
| `idCards.export.includeUnprinted` | ID Card Export |
| `idCards.export.options` | ID Card Export |
| `idCards.export.quality` | ID Card Export |
| `idCards.export.sides` | ID Card Export |
| `idCards.export.studentSelection` | ID Card Export |
| `idCards.exportAsImages` | Export as images |
| `idCards.exportAsPdf` | Export as pdf |
| `idCards.exportFailed` | Export failed |
| `idCards.exportSuccess` | Export success |
| `idCards.feePaid` | Fee Paid |
| `idCards.feeStatus` | Fee Status |
| `idCards.feeUnpaid` | Unpaid |
| `idCards.fieldColorDescription` | Set custom color for this field, or reset to use global color |
| `idCards.fieldFontSettings` | Field-Specific Font Settings |
| `idCards.fields` | Fields |
| `idCards.fieldSettings` | Field Settings |
| `idCards.fieldSpecificFontSettings` | Field-Specific Font Settings |
| `idCards.fieldValue` | Field Value |
| `idCards.fontFamily` | Font Family |
| `idCards.fontSize` | Font Size (px) |
| `idCards.front` | Front Only |
| `idCards.frontPreview` | Front Preview |
| `idCards.frontSide` | Front Side |
| `idCards.generateIdCards` | Generate id cards |
| `idCards.generateIdCardsDescription` | Select students and generate ID cards based on the selected template. |
| `idCards.globalSettings` | Global Settings |
| `idCards.height` | Height (%) |
| `idCards.layoutEditor` | Layout Editor |
| `idCards.layoutEditorDescription` | Drag fields to position them on the ID card. Click to select a field. |
| `idCards.leaveEmptyToUseGlobal` | Leave empty to use global font size |
| `idCards.noCards` | No ID cards found |
| `idCards.noPreviewAvailable` | Preview not available |
| `idCards.noPrintedCards` | No printed cards found |
| `idCards.notAssigned` | Not Assigned |
| `idCards.notesDescription` | Custom text to display. Leave empty to use card notes. |
| `idCards.notesPlaceholder` | Enter notes text... |
| `idCards.noUnprintedCards` | No unprinted cards found |
| `idCards.photoSize` | Photo Size (% of card) |
| `idCards.previewFailed` | Preview failed |
| `idCards.previewPlaceholder` | Preview placeholder |
| `idCards.printed` | Include Unprinted Cards |
| `idCards.printedAt` | Printed At |
| `idCards.printedStatus` | Printed Status |
| `idCards.qrCodeSize` | QR Code Size (% of card) |
| `idCards.qrCodeValueSource` | QR Code Value Source |
| `idCards.qrCodeValueSourceDescription` | Select what data should be encoded into the QR code. |
| `idCards.schoolNameDescription` | Custom school name. Leave empty to use student |
| `idCards.schoolNamePlaceholder` | Enter school name... |
| `idCards.schoolNameValue` | School Name |
| `idCards.selectedCards` | Selected cards |
| `idCards.selectedCount` | Selected count |
| `idCards.selectedStudents` | Selected |
| `idCards.selectExpiryDate` | Select expiry date... |
| `idCards.selectFont` | Select font |
| `idCards.selectPrinted` | Select Printed |
| `idCards.selectQrValueSource` | Select QR value source |
| `idCards.selectStudentAndTemplate` | Please select a student and template to preview |
| `idCards.selectStudentForPreview` | Select student |
| `idCards.selectStudents` | Select students |
| `idCards.selectTemplatePlaceholder` | Select template placeholder |
| `idCards.selectUnprinted` | Select Unprinted |
| `idCards.selectUseGlobalFont` | Select "Use Global Font" to use the global font setting |
| `idCards.sizeDescription` | Values are percentages of the card. Leave empty to use default size. |
| `idCards.status.assigned` | Status |
| `idCards.status.feePaid` | Status |
| `idCards.status.feeUnpaid` | Status |
| `idCards.status.notAssigned` | Status |
| `idCards.status.printed` | Status |
| `idCards.status.unprinted` | Status |
| `idCards.studentCode` | Student Code |
| `idCards.studentId` | Student ID |
| `idCards.template` | Template |
| `idCards.templateName` | Template Name |
| `idCards.templateNamePlaceholder` | e.g., Student ID Card |
| `idCards.templateNotLoaded` | Template not loaded |
| `idCards.templates` | Templates |
| `idCards.textColor` | Text Color |
| `idCards.totalCards` | Total Cards |
| `idCards.totalFeeCollected` | Fee Collected |
| `idCards.useGlobalFont` | Use global font |
| `idCards.width` | Width (%) |
...
| `library.codePlaceholder` | مثال: FIC, NON-FIC, REF |
...
### `pages/library/library.fa.ts` (FA)
...
| Key | Value |
|-----|-------|
| `questionBank.academicYear` | Question Bank |
| `questionBank.activate` | Question Bank |
| `questionBank.addOption` | Question Bank |
| `questionBank.classAcademicYear` | Question Bank |
| `questionBank.classSubject` | Question Bank |
| `questionBank.correct` | Question Bank |
| `questionBank.correctAnswer` | Question Bank |
| `questionBank.correctAnswerPlaceholder` | Question Bank |
| `questionBank.createDescription` | Question Bank |
| `questionBank.deactivate` | Question Bank |
| `questionBank.deleteConfirmMessage` | Question Bank |
| `questionBank.editDescription` | Question Bank |
| `questionBank.filterAcademicYear` | Question Bank |
| `questionBank.filterClass` | Question Bank |
| `questionBank.filterDifficulty` | Question Bank |
| `questionBank.filterSchool` | Question Bank |
| `questionBank.filterSubject` | Question Bank |
| `questionBank.filterType` | Question Bank |
| `questionBank.marks` | Question Bank |
| `questionBank.noQuestions` | Question Bank |
| `questionBank.noQuestionsFound` | Question Bank |
| `questionBank.optionPlaceholder` | Question Bank |
| `questionBank.options` | Question Bank |
| `questionBank.questionsList` | Question Bank |
| `questionBank.questionText` | Question Bank |
| `questionBank.questionTextPlaceholder` | Question Bank |
| `questionBank.reference` | Question Bank |
| `questionBank.referencePlaceholder` | Question Bank |
| `questionBank.school` | Question Bank |
| `questionBank.selectAcademicYear` | Question Bank |
| `questionBank.selectAcademicYearFirst` | Question Bank |
| `questionBank.selectSubject` | Question Bank |
| `questionBank.subject` | Question Bank |
...
### `pages/settings/settings.ar.ts` (AR)

| Key | Value |
|-----|-------|
| `settings.buildings.addBuilding` | Settings |
| `settings.buildings.buildingName` | Settings |
| `settings.buildings.create` | Settings |
| `settings.buildings.createdAt` | Settings |
| `settings.buildings.deleteConfirm` | Settings |
| `settings.buildings.deleteConfirmRooms` | Settings |
| `settings.buildings.editBuilding` | Settings |
| `settings.buildings.enterBuildingName` | Settings |
| `settings.buildings.exportErrorExcel` | Settings |
| `settings.buildings.exportErrorNoBuildings` | Settings |
| `settings.buildings.exportErrorNoSchool` | Settings |
| `settings.buildings.exportErrorPdf` | Settings |
| `settings.buildings.exportSuccessExcel` | Settings |
| `settings.buildings.exportSuccessPdf` | Settings |
| `settings.buildings.loadingBuildings` | Settings |
| `settings.buildings.management` | Settings |
| `settings.buildings.na` | Settings |
| `settings.buildings.noBuildingsFound` | Settings |
| `settings.buildings.noBuildingsMessage` | Settings |
| `settings.buildings.reportBuildingName` | Settings |
| `settings.buildings.reportCreatedAt` | Settings |
| `settings.buildings.reportOrganization` | Settings |
| `settings.buildings.reportRoomsCount` | Settings |
| `settings.buildings.reportSchoolName` | Settings |
| `settings.buildings.reportTitle` | Settings |
| `settings.buildings.room` | Settings |
| `settings.buildings.rooms` | Settings |
| `settings.buildings.school` | Settings |
| `settings.buildings.schoolRequired` | Settings |
| `settings.buildings.searchPlaceholder` | Settings |
| `settings.buildings.selectSchool` | Settings |
| `settings.buildings.title` | Settings |
| `settings.buildings.unknownSchool` | Settings |
| `settings.buildings.update` | Settings |
| `settings.rooms.addRoom` | Settings |
| `settings.rooms.building` | Settings |
| `settings.rooms.create` | Settings |
| `settings.rooms.createdAt` | Settings |
| `settings.rooms.deleteConfirm` | Settings |
| `settings.rooms.deleteConfirmRooms` | Settings |
| `settings.rooms.editRoom` | Settings |
| `settings.rooms.exportErrorExcel` | Settings |
| `settings.rooms.exportErrorNoRooms` | Settings |
| `settings.rooms.exportErrorNoSchool` | Settings |
| `settings.rooms.exportErrorPdf` | Settings |
| `settings.rooms.exportSuccessExcel` | Settings |
| `settings.rooms.exportSuccessPdf` | Settings |
| `settings.rooms.loadingRooms` | Settings |
| `settings.rooms.management` | Settings |
| `settings.rooms.na` | Settings |
| `settings.rooms.noRoomsFound` | Settings |
| `settings.rooms.noRoomsMessage` | Settings |
| `settings.rooms.noStaffAssigned` | Settings |
| `settings.rooms.reportTitle` | Settings |
| `settings.rooms.roomNumber` | Settings |
| `settings.rooms.searchPlaceholder` | Settings |
| `settings.rooms.selectBuilding` | Settings |
| `settings.rooms.selectStaff` | Settings |
| `settings.rooms.staffWarden` | Settings |
| `settings.rooms.staffWardenOptional` | Settings |
...
| Key | Value |
|-----|-------|
| `staff.acrossSelected` | Staff |
| `staff.activeStaff` | Staff |
| `staff.adminCount` | Staff |
| `staff.list` | Staff |
| `staff.listDescription` | Staff |
| `staff.modernDepartment` | Staff |
| `staff.modernInstitution` | Staff |
| `staff.onLeaveStaff` | Staff |
...
| Key | Value |
|-----|-------|
| `students.admissionNumber` | students |
| `students.approvalAdmission` | students |
| `students.approvalDate` | students |
| `students.approvalFee` | students |
| `students.approvalSignature` | students |
| `students.approvalStamp` | students |
| `students.approvalTitle` | students |
| `students.commitmentsTitle` | students |
| `students.commitmentText1` | students |
| `students.commitmentText2` | students |
| `students.commitmentText3` | students |
| `students.commitmentText4` | students |
| `students.commitmentText5` | students |
| `students.commitmentText6` | students |
| `students.commitmentTitle` | students |
| `students.enrollmentStatus` | students |
| `students.fee` | students |
| `students.grade` | students |
| `students.guaranteeText` | students |
| `students.guaranteeTitle` | students |
| `students.guarantorSignature` | students |
| `students.idNumber` | students |
| `students.noImage` | students |
| `students.noStudents` | students |
| `students.orphans` | students |
| `students.picture` | students |
| `students.printTitle` | students |
| `students.registrationNumber` | students |
| `students.selectPicture` | students |
| `students.stamp` | students |
| `students.studentId` | students |
| `students.students` | students |
| `students.tazkiraNumber` | students |
...
### `pages/subscription/subscription.ar.ts` (AR)
...
### `pages/user-management/userManagement.ar.ts` (AR)
...
| Key | Value |
|-----|-------|
| `watermarks.enterFontFamily` | مثال: Arial، Times New Roman |
...
### `pages/watermarks/watermarks.fa.ts` (FA)
...
| Key | Value |
|-----|-------|
| `websiteAdmin.common.filters` | Filters |
| `websiteAdmin.common.search` | Search |
| `websiteAdmin.common.status` | Status |
| `websiteAdmin.common.publishedAt` | Published At |
| `websiteAdmin.common.expiresAt` | Expires At |
| `websiteAdmin.common.actions` | Actions |
| `websiteAdmin.common.title` | Title |
| `websiteAdmin.common.slug` | Slug |
| `websiteAdmin.common.excerpt` | Excerpt |
| `websiteAdmin.common.content` | Content |
| `websiteAdmin.common.description` | Description |
| `websiteAdmin.common.category` | Category |
| `websiteAdmin.common.type` | Type |
| `websiteAdmin.common.visible` | Visible |
| `websiteAdmin.common.order` | Order |
| `websiteAdmin.common.url` | URL |
| `websiteAdmin.common.parent` | Parent |
| `websiteAdmin.common.created` | Created |
| `websiteAdmin.common.preview` | Preview |
| `websiteAdmin.common.fileName` | File Name |
| `websiteAdmin.common.altText` | Alt Text |
| `websiteAdmin.common.public` | Public |
| `websiteAdmin.common.yes` | Yes |
| `websiteAdmin.common.no` | No |
| `websiteAdmin.common.all` | All |
| `websiteAdmin.common.none` | None |
| `websiteAdmin.common.notSet` | Not Set |
| `websiteAdmin.common.sortOrder` | Sort Order |
| `websiteAdmin.common.uploading` | Uploading... |
| `websiteAdmin.statuses.draft` | Draft |
| `websiteAdmin.statuses.scheduled` | Scheduled |
| `websiteAdmin.statuses.published` | Published |
| `websiteAdmin.statuses.archived` | Archived |
| `websiteAdmin.statuses.assigned` | Assigned |
| `websiteAdmin.statuses.answered` | Answered |
| `websiteAdmin.statuses.active` | Active |
| `websiteAdmin.statuses.inactive` | Inactive |
| `websiteAdmin.statuses.pending` | Pending |
| `websiteAdmin.statuses.verified` | Verified |
| `websiteAdmin.statuses.unverified` | Unverified |
| `websiteAdmin.statuses.expired` | Expired |
| `websiteAdmin.announcements.title` | Announcements |
| `websiteAdmin.announcements.description` | Manage website announcements |
| `websiteAdmin.announcements.new` | New Announcement |
| `websiteAdmin.announcements.searchPlaceholder` | Search announcements... |
| `websiteAdmin.announcements.pinned` | Pinned |
| `websiteAdmin.announcements.pinToHomepage` | Pin to Homepage |
| `websiteAdmin.announcements.noResults` | No announcements found |
| `websiteAdmin.announcements.createTitle` | Create Announcement |
| `websiteAdmin.announcements.createDescription` | Create a new announcement |
| `websiteAdmin.announcements.editTitle` | Edit Announcement |
| `websiteAdmin.announcements.editDescription` | Update announcement details |
| `websiteAdmin.announcements.deleteTitle` | Delete Announcement |
| `websiteAdmin.announcements.deleteDescription` | Are you sure you want to delete this announcement? This action cannot be undone. |
| `websiteAdmin.announcements.fields.title` | Title |
| `websiteAdmin.announcements.fields.content` | Content |
| `websiteAdmin.announcements.fields.status` | Status |
| `websiteAdmin.announcements.fields.publishedAt` | Published At |
| `websiteAdmin.announcements.fields.expiresAt` | Expires At |
| `websiteAdmin.announcements.placeholders.title` | Announcement title |
| `websiteAdmin.announcements.placeholders.content` | Announcement content... |
| `websiteAdmin.articles.title` | Articles & Blog |
| `websiteAdmin.articles.description` | Manage blog posts and articles |
| `websiteAdmin.articles.new` | New Article |
| `websiteAdmin.articles.searchPlaceholder` | Search articles... |
| `websiteAdmin.articles.noResults` | No articles found |
| `websiteAdmin.articles.createTitle` | Create Article |
| `websiteAdmin.articles.createDescription` | Create a new blog post or article |
| `websiteAdmin.articles.editTitle` | Edit Article |
| `websiteAdmin.articles.editDescription` | Update article details |
| `websiteAdmin.articles.deleteTitle` | Delete Article |
| `websiteAdmin.articles.deleteDescription` | Are you sure you want to delete this article? This action cannot be undone. |
| `websiteAdmin.articles.fields.slug` | Slug |
| `websiteAdmin.articles.fields.title` | Title |
| `websiteAdmin.articles.fields.excerpt` | Excerpt |
| `websiteAdmin.articles.fields.content` | Article Content |
| `websiteAdmin.articles.fields.status` | Status |
| `websiteAdmin.articles.fields.publishedAt` | Published At |
| `websiteAdmin.articles.placeholders.slug` | my-article |
| `websiteAdmin.articles.placeholders.title` | Article title |
| `websiteAdmin.articles.placeholders.excerpt` | Brief summary of the article... |
| `websiteAdmin.articles.placeholders.content` | Write your article... |
| `websiteAdmin.pages.title` | Pages |
| `websiteAdmin.pages.description` | Manage website pages |
| `websiteAdmin.pages.new` | New Page |
| `websiteAdmin.pages.searchPlaceholder` | Search pages... |
| `websiteAdmin.pages.noResults` | No pages found |
| `websiteAdmin.pages.createTitle` | Create Page |
| `websiteAdmin.pages.createDescription` | Create a new website page |
| `websiteAdmin.pages.editTitle` | Edit Page |
| `websiteAdmin.pages.editDescription` | Update page details |
| `websiteAdmin.pages.deleteTitle` | Delete Page |
| `websiteAdmin.pages.deleteDescription` | Are you sure you want to delete this page? This action cannot be undone. |
| `websiteAdmin.pages.fields.slug` | Slug |
| `websiteAdmin.pages.fields.title` | Title |
| `websiteAdmin.pages.fields.status` | Status |
| `websiteAdmin.pages.fields.publishedAt` | Published At |
| `websiteAdmin.pages.fields.content` | Content |
| `websiteAdmin.pages.placeholders.slug` | about-us |
| `websiteAdmin.pages.placeholders.title` | About Us |
| `websiteAdmin.navigation.title` | Navigation |
| `websiteAdmin.navigation.description` | Manage header and footer menus |
| `websiteAdmin.navigation.new` | New Menu Item |
| `websiteAdmin.navigation.searchPlaceholder` | Search menu items... |
| `websiteAdmin.navigation.noResults` | No menu items found |
| `websiteAdmin.navigation.createTitle` | Create Menu Item |
| `websiteAdmin.navigation.createDescription` | Add a new menu item |
| `websiteAdmin.navigation.editTitle` | Edit Menu Item |
| `websiteAdmin.navigation.editDescription` | Update menu item details |
| `websiteAdmin.navigation.deleteTitle` | Delete Menu Item |
| `websiteAdmin.navigation.deleteDescription` | Are you sure you want to delete this menu item? This action cannot be undone. |
| `websiteAdmin.navigation.fields.label` | Label |
| `websiteAdmin.navigation.fields.url` | URL |
| `websiteAdmin.navigation.fields.parentMenu` | Parent Menu |
| `websiteAdmin.navigation.fields.sortOrder` | Sort Order |
| `websiteAdmin.navigation.fields.visible` | Visible |
| `websiteAdmin.navigation.fields.linkToPage` | Link to Page (Optional) |
| `websiteAdmin.navigation.fields.order` | Order |
| `websiteAdmin.navigation.placeholders.selectPage` | Select a page... |
| `websiteAdmin.navigation.placeholders.label` | Home |
| `websiteAdmin.navigation.placeholders.url` | /home |
| `websiteAdmin.navigation.placeholders.parentNone` | None (Top Level) |
| `websiteAdmin.events.title` | Events |
| `websiteAdmin.events.description` | Manage website events calendar |
| `websiteAdmin.events.new` | New Event |
| `websiteAdmin.events.searchPlaceholder` | Search events... |
| `websiteAdmin.events.noResults` | No events found |
| `websiteAdmin.events.createTitle` | Create Event |
| `websiteAdmin.events.createDescription` | Create a new event |
| `websiteAdmin.events.editTitle` | Edit Event |
| `websiteAdmin.events.editDescription` | Update event details |
| `websiteAdmin.events.deleteTitle` | Delete Event |
| `websiteAdmin.events.deleteDescription` | Are you sure you want to delete this event? This action cannot be undone. |
| `websiteAdmin.events.fields.title` | Title |
| `websiteAdmin.events.fields.location` | Location |
| `websiteAdmin.events.fields.startsAt` | Starts At |
| `websiteAdmin.events.fields.endsAt` | Ends At |
| `websiteAdmin.events.fields.summary` | Summary |
| `websiteAdmin.events.fields.publicEvent` | Public Event |
| `websiteAdmin.events.placeholders.title` | Event title |
| `websiteAdmin.events.placeholders.location` | Event location |
| `websiteAdmin.events.placeholders.summary` | Brief event summary... |
| `websiteAdmin.domains.title` | Domains |
| `websiteAdmin.domains.description` | Manage website domains |
| `websiteAdmin.domains.new` | Add Domain |
| `websiteAdmin.domains.searchPlaceholder` | Search domains... |
| `websiteAdmin.domains.noResults` | No domains found |
| `websiteAdmin.domains.createTitle` | Add Domain |
| `websiteAdmin.domains.createDescription` | Add a new domain |
| `websiteAdmin.domains.editTitle` | Edit Domain |
| `websiteAdmin.domains.editDescription` | Update domain details |
| `websiteAdmin.domains.deleteTitle` | Delete Domain |
| `websiteAdmin.domains.deleteDescription` | Are you sure you want to delete this domain? This action cannot be undone. |
| `websiteAdmin.domains.fields.domain` | Domain |
| `websiteAdmin.domains.fields.primary` | Primary Domain |
| `websiteAdmin.domains.fields.verificationStatus` | Verification Status |
| `websiteAdmin.domains.fields.sslStatus` | SSL Status |
| `websiteAdmin.domains.placeholders.domain` | example.com |
| `websiteAdmin.domains.placeholders.selectStatus` | Select status |
| `websiteAdmin.media.title` | Media |
| `websiteAdmin.media.description` | Manage website media library |
| `websiteAdmin.media.new` | Upload Media |
| `websiteAdmin.media.searchPlaceholder` | Search media... |
| `websiteAdmin.media.noResults` | No media found |
| `websiteAdmin.media.createTitle` | Add Media |
| `websiteAdmin.media.createDescription` | Add a new media item to your library |
| `websiteAdmin.media.editTitle` | Edit Media |
| `websiteAdmin.media.editDescription` | Update media details |
| `websiteAdmin.media.deleteTitle` | Delete Media |
| `websiteAdmin.media.deleteDescription` | Are you sure you want to delete this media item? This action cannot be undone. |
| `websiteAdmin.media.previewAlt` | Media preview |
| `websiteAdmin.media.libraryPickerTitle` | Select from library |
| `websiteAdmin.media.libraryPickerDescription` | Choose an existing image to use |
| `websiteAdmin.media.noLibraryImages` | No images in library. Upload some first. |
| `websiteAdmin.media.fields.type` | Type |
| `websiteAdmin.media.fields.category` | Category |
| `websiteAdmin.media.fields.filePath` | File Path |
| `websiteAdmin.media.fields.fileName` | Title / File Name |
| `websiteAdmin.media.fields.altText` | Alt Text / Description |
| `websiteAdmin.media.placeholders.search` | Search media... |
| `websiteAdmin.media.placeholders.selectCategory` | Select category |
| `websiteAdmin.media.placeholders.imageUrl` | https://... or path |
| `websiteAdmin.media.placeholders.videoUrl` | https://www.youtube.com/watch?v=... |
| `websiteAdmin.media.placeholders.documentUrl` | https://... |
| `websiteAdmin.media.placeholders.fileName` | My Great Photo |
| `websiteAdmin.media.placeholders.altText` | Brief description of the content |
| `websiteAdmin.media.helpers.uploadOrSelect` | Upload or select image |
| `websiteAdmin.media.helpers.uploadHint` | Upload (1 or many) |
| `websiteAdmin.media.helpers.imageUrlHint` | Image URL or path (or use upload / library above) |
| `websiteAdmin.media.helpers.videoHint` | Supports YouTube, Vimeo, or direct MP4 links. |
| `websiteAdmin.media.helpers.categoryAppliesToAll` | {count} image(s) ready — category/alt below apply to all |
| `websiteAdmin.media.types.image` | Image |
| `websiteAdmin.media.types.video` | Video (YouTube/Link) |
| `websiteAdmin.media.types.document` | Document |
| `websiteAdmin.media.uncategorized` | Uncategorized |
| `websiteAdmin.media.selectFromLibrary` | Select from library |
| `websiteAdmin.media.addFromLibrary` | Select from library |
| `websiteAdmin.fatwas.title` | Questions & Fatwas |
| `websiteAdmin.fatwas.description` | Manage fatwas, categories, and questions |
| `websiteAdmin.fatwas.editTitle` | Edit Fatwa |
| `websiteAdmin.fatwas.editDescription` | Update fatwa details |
| `websiteAdmin.fatwas.editCategoryTitle` | Edit Category |
| `websiteAdmin.fatwas.editCategoryDescription` | Update category details |
| `websiteAdmin.fatwas.tabs.fatwas` | Fatwas |
| `websiteAdmin.fatwas.tabs.categories` | Categories |
| `websiteAdmin.fatwas.tabs.questions` | Questions |
| `websiteAdmin.fatwas.newFatwa` | New Fatwa |
| `websiteAdmin.fatwas.newCategory` | New Category |
| `websiteAdmin.fatwas.anonymous` | Anonymous |
| `websiteAdmin.fatwas.noFatwas` | No fatwas found |
| `websiteAdmin.fatwas.noCategories` | No categories found |
| `websiteAdmin.fatwas.noQuestions` | No questions found |
| `websiteAdmin.fatwas.searchFatwas` | Search fatwas... |
| `websiteAdmin.fatwas.searchQuestions` | Search questions... |
| `websiteAdmin.fatwas.fields.slug` | Slug |
| `websiteAdmin.fatwas.fields.title` | Title |
| `websiteAdmin.fatwas.fields.category` | Category |
| `websiteAdmin.fatwas.fields.question` | Question |
| `websiteAdmin.fatwas.fields.answer` | Answer |
| `websiteAdmin.fatwas.fields.status` | Status |
| `websiteAdmin.fatwas.fields.featured` | Featured |
| `websiteAdmin.fatwas.fields.publishedAt` | Published At |
| `websiteAdmin.fatwas.fields.name` | Name |
| `websiteAdmin.fatwas.fields.description` | Description |
| `websiteAdmin.fatwas.fields.sortOrder` | Sort Order |
| `websiteAdmin.fatwas.fields.active` | Active |
| `websiteAdmin.fatwas.fields.assignedTo` | Assigned To |
| `websiteAdmin.fatwas.fields.internalNotes` | Internal Notes |
| `websiteAdmin.fatwas.fields.answerDraft` | Answer Draft |
| `websiteAdmin.fatwas.placeholders.slug` | fatwa-slug |
| `websiteAdmin.fatwas.placeholders.title` | Fatwa title |
| `websiteAdmin.fatwas.placeholders.question` | The question text... |
| `websiteAdmin.fatwas.placeholders.answer` | The fatwa answer... |
| `websiteAdmin.fatwas.placeholders.categorySlug` | category-slug |
| `websiteAdmin.fatwas.placeholders.categoryName` | Category name |
| `websiteAdmin.fatwas.placeholders.categoryDescription` | Category description... |
| `websiteAdmin.fatwas.placeholders.assignedTo` | User ID or email |
| `websiteAdmin.fatwas.placeholders.internalNotes` | Internal notes for moderation... |
| `websiteAdmin.fatwas.placeholders.answerDraft` | Draft answer... |
| `websiteAdmin.fatwas.placeholders.selectCategory` | Select category |
| `websiteAdmin.fatwas.moderation.title` | Moderate Question |
| `websiteAdmin.fatwas.moderation.description` | Update question status and assignment |
| `websiteAdmin.fatwas.moderation.submittedBy` | Submitted by |
| `websiteAdmin.fatwas.moderation.questionLabel` | Question |
| `websiteAdmin.fatwas.delete.titleFatwa` | Delete Fatwa |
| `websiteAdmin.fatwas.delete.titleCategory` | Delete Category |
| `websiteAdmin.fatwas.delete.descriptionFatwa` | Are you sure you want to delete this fatwa? This action cannot be undone. |
| `websiteAdmin.fatwas.delete.descriptionCategory` | Are you sure you want to delete this category? This action cannot be undone. |
| `websiteAdmin.gallery.title` | Gallery Categories |
| `websiteAdmin.gallery.description` | Manage gallery categories and albums |
| `websiteAdmin.gallery.new` | New Category |
| `websiteAdmin.gallery.searchPlaceholder` | Search categories... |
| `websiteAdmin.gallery.noResults` | No categories found |
| `websiteAdmin.gallery.slugLabel` | Slug |
| `websiteAdmin.gallery.sortLabel` | Sort Order |
| `websiteAdmin.gallery.noDescription` | No description |
| `websiteAdmin.gallery.createTitle` | Create Gallery Category |
| `websiteAdmin.gallery.createDescription` | Add a new gallery category |
| `websiteAdmin.gallery.editTitle` | Edit Gallery Category |
| `websiteAdmin.gallery.editDescription` | Update gallery category details |
| `websiteAdmin.gallery.deleteTitle` | Delete Gallery Category |
| `websiteAdmin.gallery.deleteDescription` | Are you sure you want to delete this category? This action cannot be undone. |
| `websiteAdmin.gallery.fields.name` | Name |
| `websiteAdmin.gallery.fields.coverImage` | Cover Image |
| `websiteAdmin.gallery.placeholders.name` | Category name |
| `websiteAdmin.gallery.placeholders.slug` | gallery-category |
| `websiteAdmin.gallery.placeholders.coverPath` | Image path or URL |
| `websiteAdmin.gallery.coverUploadCta` | Upload a cover image or choose from the library |
| `websiteAdmin.gallery.coverPreviewAlt` | Gallery cover preview |
| `websiteAdmin.courses.title` | Courses |
| `websiteAdmin.courses.description` | Manage public courses |
| `websiteAdmin.courses.new` | New Course |
| `websiteAdmin.courses.searchPlaceholder` | Search courses... |
| `websiteAdmin.courses.noResults` | No courses found |
| `websiteAdmin.courses.createTitle` | Create Course |
| `websiteAdmin.courses.createDescription` | Add a new course |
| `websiteAdmin.courses.editTitle` | Edit Course |
| `websiteAdmin.courses.editDescription` | Update course details |
| `websiteAdmin.courses.deleteTitle` | Delete Course |
| `websiteAdmin.courses.deleteDescription` | Are you sure you want to delete this course? This action cannot be undone. |
| `websiteAdmin.courses.fields.title` | Title |
| `websiteAdmin.courses.fields.instructor` | Instructor |
| `websiteAdmin.courses.fields.duration` | Duration |
| `websiteAdmin.courses.fields.level` | Level |
| `websiteAdmin.courses.fields.enrollmentLink` | Enrollment Link |
| `websiteAdmin.courses.fields.coverImage` | Cover Image |
| `websiteAdmin.courses.placeholders.title` | Course title |
| `websiteAdmin.courses.placeholders.instructor` | Instructor name |
| `websiteAdmin.courses.placeholders.duration` | e.g. 8 weeks |
| `websiteAdmin.courses.placeholders.level` | Select level |
| `websiteAdmin.courses.placeholders.enrollmentLink` | https://... |
| `websiteAdmin.courses.placeholders.description` | Course description... |
| `websiteAdmin.courses.placeholders.category` | Category |
| `websiteAdmin.courses.levels.beginner` | Beginner |
| `websiteAdmin.courses.levels.intermediate` | Intermediate |
| `websiteAdmin.courses.levels.advanced` | Advanced |
| `websiteAdmin.courses.featured` | Featured |
| `websiteAdmin.courses.uploadImage` | Upload Cover |
| `websiteAdmin.courses.coverPreviewAlt` | Course cover preview |
| `websiteAdmin.courses.noImage` | No cover image |
| `websiteAdmin.courses.enrollmentHelp` | Paste the enrollment link or leave blank to hide button |
| `websiteAdmin.library.title` | Library |
| `websiteAdmin.library.description` | Manage public library books |
| `websiteAdmin.library.new` | New Book |
| `websiteAdmin.library.searchPlaceholder` | Search books... |
| `websiteAdmin.library.noResults` | No books found |
| `websiteAdmin.library.createTitle` | Add Book |
| `websiteAdmin.library.createDescription` | Add a new book to the library |
| `websiteAdmin.library.editTitle` | Edit Book |
| `websiteAdmin.library.editDescription` | Update book details |
| `websiteAdmin.library.deleteTitle` | Delete Book |
| `websiteAdmin.library.deleteDescription` | Are you sure you want to delete this book? This action cannot be undone. |
| `websiteAdmin.library.fields.title` | Title |
| `websiteAdmin.library.fields.author` | Author |
| `websiteAdmin.library.fields.coverImage` | Cover Image |
| `websiteAdmin.library.fields.file` | PDF File |
| `websiteAdmin.library.fields.downloads` | Downloads |
| `websiteAdmin.library.placeholders.title` | Book title |
| `websiteAdmin.library.placeholders.author` | Author name |
| `websiteAdmin.library.placeholders.category` | Category |
| `websiteAdmin.library.placeholders.description` | Book summary... |
| `websiteAdmin.library.placeholders.fileUrl` | https://...pdf |
| `websiteAdmin.library.uploadCover` | Upload Cover |
| `websiteAdmin.library.uploadFile` | Upload File |
| `websiteAdmin.library.featured` | Featured on homepage |
| `websiteAdmin.library.coverPreviewAlt` | Book cover preview |
| `websiteAdmin.donations.title` | Donations |
| `websiteAdmin.donations.description` | Manage public donation campaigns |
| `websiteAdmin.donations.new` | New Campaign |
| `websiteAdmin.donations.searchPlaceholder` | Search campaigns... |
| `websiteAdmin.donations.noResults` | No campaigns found |
| `websiteAdmin.donations.createTitle` | Create Campaign |
| `websiteAdmin.donations.createDescription` | Create a new donation campaign |
| `websiteAdmin.donations.editTitle` | Edit Campaign |
| `websiteAdmin.donations.editDescription` | Update campaign details |
| `websiteAdmin.donations.deleteTitle` | Delete Campaign |
| `websiteAdmin.donations.deleteDescription` | Are you sure you want to delete this campaign? This action cannot be undone. |
| `websiteAdmin.donations.fields.fundName` | Fund Name |
| `websiteAdmin.donations.fields.target` | Target Amount |
| `websiteAdmin.donations.fields.raised` | Raised Amount |
| `websiteAdmin.donations.fields.progress` | Progress |
| `websiteAdmin.donations.fields.active` | Active |
| `websiteAdmin.donations.placeholders.fundName` | Fund name |
| `websiteAdmin.donations.placeholders.description` | Campaign description... |
| `websiteAdmin.scholars.title` | Scholars |
| `websiteAdmin.scholars.description` | Manage public scholars directory |
| `websiteAdmin.scholars.new` | New Scholar |
| `websiteAdmin.scholars.searchPlaceholder` | Search scholars... |
| `websiteAdmin.scholars.noResults` | No scholars found |
| `websiteAdmin.scholars.createTitle` | Add Scholar |
| `websiteAdmin.scholars.createDescription` | Add a scholar profile |
| `websiteAdmin.scholars.editTitle` | Edit Scholar |
| `websiteAdmin.scholars.editDescription` | Update scholar profile |
| `websiteAdmin.scholars.deleteTitle` | Delete Scholar |
| `websiteAdmin.scholars.deleteDescription` | Are you sure you want to delete this scholar? This action cannot be undone. |
| `websiteAdmin.scholars.fields.name` | Name |
| `websiteAdmin.scholars.fields.title` | Title |
| `websiteAdmin.scholars.fields.email` | Email |
| `websiteAdmin.scholars.fields.bio` | Bio |
| `websiteAdmin.scholars.placeholders.name` | Full name |
| `websiteAdmin.scholars.placeholders.title` | Title or role |
| `websiteAdmin.scholars.placeholders.email` | name@example.com |
| `websiteAdmin.scholars.placeholders.bio` | Short biography... |
| `websiteAdmin.scholars.featured` | Featured on homepage |
| `websiteAdmin.graduates.title` | Graduates & Alumni |
| `websiteAdmin.graduates.description` | Showcase graduation cohorts and alumni |
| `websiteAdmin.graduates.new` | New Graduate |
| `websiteAdmin.graduates.searchPlaceholder` | Search graduates... |
| `websiteAdmin.graduates.noResults` | No graduates found |
| `websiteAdmin.graduates.createTitle` | Add Graduate |
| `websiteAdmin.graduates.createDescription` | Add a new graduate to the alumni showcase |
| `websiteAdmin.graduates.editTitle` | Edit Graduate |
| `websiteAdmin.graduates.editDescription` | Update graduate details |
| `websiteAdmin.graduates.deleteTitle` | Delete Graduate |
| `websiteAdmin.graduates.deleteDescription` | Are you sure you want to delete this graduate? |
| `websiteAdmin.graduates.fields.name` | Name |
| `websiteAdmin.graduates.fields.program` | Program / Degree |
| `websiteAdmin.graduates.fields.year` | Graduation Year |
| `websiteAdmin.graduates.fields.bio` | Biography |
| `websiteAdmin.graduates.placeholders.name` | Full name |
| `websiteAdmin.graduates.placeholders.program` | e.g. Islamic Studies |
| `websiteAdmin.graduates.placeholders.bio` | Brief biography... |
| `websiteAdmin.graduates.featured` | Featured on homepage |
| `websiteAdmin.admissions.title` | Online Admissions |
| `websiteAdmin.admissions.description` | Review and manage online admission submissions. |
| `websiteAdmin.admissions.tabs.applications` | Applications |
| `websiteAdmin.admissions.tabs.fields` | Form Fields |
| `websiteAdmin.admissions.allStatuses` | All statuses |
| `websiteAdmin.admissions.searchPlaceholder` | Search by name, guardian phone, or application number |
| `websiteAdmin.admissions.applicationsTitle` | Applications |
| `websiteAdmin.admissions.fieldsTitle` | Form Fields |
| `websiteAdmin.admissions.columns.applicationNo` | Application No |
| `websiteAdmin.admissions.columns.student` | Student |
| `websiteAdmin.admissions.columns.guardianPhone` | Guardian Phone |
| `websiteAdmin.admissions.columns.applyingGrade` | Applying Grade |
| `websiteAdmin.admissions.columns.submitted` | Submitted |
| `websiteAdmin.admissions.loading` | Loading admissions... |
| `websiteAdmin.admissions.noResults` | No admissions found. |
| `websiteAdmin.admissions.actions.view` | View |
| `websiteAdmin.admissions.actions.addField` | Add Field |
| `websiteAdmin.admissions.actions.accept` | Accept & Create Student |
| `websiteAdmin.admissions.actions.saveChanges` | Save Changes |
| `websiteAdmin.admissions.actions.confirmAcceptance` | Confirm Acceptance |
| `websiteAdmin.admissions.actions.editField` | Edit Field |
| `websiteAdmin.admissions.actions.newField` | New Field |
| `websiteAdmin.admissions.actions.saveField` | Save Field |
| `websiteAdmin.admissions.noFields` | No custom fields configured. |
| `websiteAdmin.admissions.detailsTitle` | Admission Details |
| `websiteAdmin.admissions.detailsDescription` | View and manage this online admission application. |
| `websiteAdmin.admissions.loadingSingle` | Loading admission... |
| `websiteAdmin.admissions.sections.student` | Student |
| `websiteAdmin.admissions.sections.guardian` | Guardian |
| `websiteAdmin.admissions.sections.address` | Address |
| `websiteAdmin.admissions.sections.previousSchool` | Previous School |
| `websiteAdmin.admissions.sections.statusActions` | Status & Actions |
| `websiteAdmin.admissions.sections.documents` | Documents |
| `websiteAdmin.admissions.sections.extraFields` | Extra Fields |
| `websiteAdmin.admissions.labels.father` | Father |
| `websiteAdmin.admissions.labels.applying` | Applying |
| `websiteAdmin.admissions.labels.guardian` | Guardian |
| `websiteAdmin.admissions.labels.origin` | Origin |
| `websiteAdmin.admissions.labels.current` | Current |
| `websiteAdmin.admissions.labels.grade` | Grade |
| `websiteAdmin.admissions.labels.year` | Year |
| `websiteAdmin.admissions.labels.notes` | Notes |
| `websiteAdmin.admissions.labels.internalNotes` | Internal Notes |
| `websiteAdmin.admissions.labels.rejectionReason` | Rejection Reason |
| `websiteAdmin.admissions.labels.field` | Field |
| `websiteAdmin.admissions.labels.download` | Download |
| `websiteAdmin.admissions.labels.admissionNoOptional` | Admission Number (optional) |
| `websiteAdmin.admissions.labels.admissionYearOptional` | Admission Year (optional) |
| `websiteAdmin.admissions.selectStatus` | Select status |
| `websiteAdmin.admissions.placeholders.internalNotes` | Internal notes... |
| `websiteAdmin.admissions.placeholders.rejectionReason` | Reason for rejection... |
| `websiteAdmin.admissions.noDocuments` | No documents uploaded. |
| `websiteAdmin.admissions.noExtraFields` | No extra fields filled. |
| `websiteAdmin.admissions.acceptTitle` | Accept Admission |
| `websiteAdmin.admissions.acceptDescription` | Create a student record from this application. Optionally set admission numbe... |
| `websiteAdmin.admissions.fieldDialog.editDescription` | Update the admission form field. |
| `websiteAdmin.admissions.fieldDialog.newDescription` | Add a new field to the online admission form. |
| `websiteAdmin.admissions.fieldForm.key` | Key |
| `websiteAdmin.admissions.fieldForm.label` | Label |
| `websiteAdmin.admissions.fieldForm.type` | Field Type |
| `websiteAdmin.admissions.fieldForm.selectType` | Select type |
| `websiteAdmin.admissions.fieldForm.sortOrder` | Sort Order |
| `websiteAdmin.admissions.fieldForm.options` | Options (comma separated) |
| `websiteAdmin.admissions.fieldForm.placeholder` | Placeholder |
| `websiteAdmin.admissions.fieldForm.helpText` | Help Text |
| `websiteAdmin.admissions.fieldForm.required` | Required |
| `websiteAdmin.admissions.fieldForm.enabled` | Enabled |
| `websiteAdmin.admissions.fieldTypes.text` | Text |
| `websiteAdmin.admissions.fieldTypes.textarea` | Textarea |
| `websiteAdmin.admissions.fieldTypes.phone` | Phone |
| `websiteAdmin.admissions.fieldTypes.number` | Number |
| `websiteAdmin.admissions.fieldTypes.select` | Select |
| `websiteAdmin.admissions.fieldTypes.multiselect` | Multi-select |
| `websiteAdmin.admissions.fieldTypes.date` | Date |
| `websiteAdmin.admissions.fieldTypes.toggle` | Toggle |
| `websiteAdmin.admissions.fieldTypes.email` | Email |
| `websiteAdmin.admissions.fieldTypes.idNumber` | ID Number |
| `websiteAdmin.admissions.fieldTypes.address` | Address |
| `websiteAdmin.admissions.fieldTypes.photo` | Photo |
| `websiteAdmin.admissions.fieldTypes.file` | File |
| `websiteAdmin.admissions.statuses.submitted` | Submitted |
| `websiteAdmin.admissions.statuses.underReview` | Under Review |
| `websiteAdmin.admissions.statuses.accepted` | Accepted |
| `websiteAdmin.admissions.statuses.rejected` | Rejected |
| `websiteAdmin.admissions.statuses.archived` | Archived |
| `websiteAdmin.inbox.title` | Inbox |
| `websiteAdmin.inbox.description` | Contact form messages and inquiries |
| `websiteAdmin.inbox.searchPlaceholder` | Search messages... |
| `websiteAdmin.inbox.noResults` | No messages found |
| `websiteAdmin.inbox.noSubject` | (No subject) |
| `websiteAdmin.inbox.received` | Received |
| `websiteAdmin.inbox.stats.new` | New |
| `websiteAdmin.inbox.stats.read` | Read |
| `websiteAdmin.inbox.stats.replied` | Replied |
| `websiteAdmin.inbox.stats.total` | Total |
| `websiteAdmin.inbox.statuses.new` | New |
| `websiteAdmin.inbox.statuses.read` | Read |
| `websiteAdmin.inbox.statuses.replied` | Replied |
| `websiteAdmin.inbox.statuses.archived` | Archived |
| `websiteAdmin.inbox.actions.markRead` | Mark as Read |
| `websiteAdmin.inbox.actions.markReplied` | Mark as Replied |
| `websiteAdmin.inbox.actions.archive` | Archive |
| `websiteAdmin.inbox.actions.delete` | Delete |
| `websiteAdmin.inbox.deleteTitle` | Delete Message |
| `websiteAdmin.inbox.deleteDescription` | Are you sure you want to delete this message? This cannot be undone. |

### `pages/website-admin/websiteAdmin.fa.ts` (FA)
...
| Key | Value |
|-----|-------|
| `errorBoundary.anErrorOccurred` | An error occurred |
| `errorBoundary.applicationCrashed` | Something went wrong and the application crashed. |
| `errorBoundary.applicationError` | Application Error |
| `errorBoundary.componentError` | Something went wrong |
| `errorBoundary.errorDetailsDev` | Error Details (Development) |
| `errorBoundary.goHome` | Go Home |
| `errorBoundary.maxRetriesReached` | Maximum retry attempts reached |
| `errorBoundary.refreshOrContactSupport` | Please refresh the page or contact support. |
| `errorBoundary.refreshPage` | Refresh Page |
| `errorBoundary.report` | Report |
| `errorBoundary.reportBug` | Report Bug |
| `errorBoundary.somethingWentWrong` | Something went wrong |
| `errorBoundary.technicalDetails` | Technical Details |
| `errorBoundary.tryAgainLater` | Please try again later. |
| `errorBoundary.tryReloading` | This component encountered an error. You can try reloading it. |
| `errorBoundary.workingOnFix` | We |

### `shared/footer/footer.ar.ts` (AR)
...
| Key | Value |
|-----|-------|
| `privacyPolicy.contact.content` | If you have any questions about this Privacy Policy or our data practices, pl... |
| `privacyPolicy.contact.title` | Contact Us |
| `privacyPolicy.dataRetention.content` | We retain your personal information for as long as necessary to provide our s... |
| `privacyPolicy.dataRetention.title` | Data Retention |
| `privacyPolicy.dataSecurity.content` | We implement industry-standard security measures to protect your information,... |
| `privacyPolicy.dataSecurity.title` | Data Security |
| `privacyPolicy.howWeUse.analytics` | To analyze usage patterns and improve user experience |
| `privacyPolicy.howWeUse.communicate` | To communicate with you about your account and our services |
| `privacyPolicy.howWeUse.provide` | To provide, maintain, and improve our services |
| `privacyPolicy.howWeUse.security` | To ensure the security and integrity of our platform |
| `privacyPolicy.howWeUse.support` | To provide customer support and respond to your inquiries |
| `privacyPolicy.howWeUse.title` | How We Use Your Information |
| `privacyPolicy.informationWeCollect.personal.content` | We collect personal information that you provide to us, such as your name, em... |
| `privacyPolicy.informationWeCollect.personal.title` | Personal Information |
| `privacyPolicy.informationWeCollect.technical.content` | We collect technical information such as IP address, browser type, device inf... |
| `privacyPolicy.informationWeCollect.technical.title` | Technical Information |
| `privacyPolicy.informationWeCollect.title` | Information We Collect |
| `privacyPolicy.informationWeCollect.usage.content` | We automatically collect information about how you use our platform, includin... |
| `privacyPolicy.informationWeCollect.usage.title` | Usage Information |
| `privacyPolicy.introduction.content` | At Nazim School Management System, we are committed to protecting your privac... |
| `privacyPolicy.introduction.title` | Introduction |
| `privacyPolicy.lastUpdated` | Last Updated: January 2026 |
| `privacyPolicy.title` | Privacy Policy |
| `privacyPolicy.yourRights.access` | Access your personal information |
| `privacyPolicy.yourRights.correct` | Correct inaccurate or incomplete information |
| `privacyPolicy.yourRights.delete` | Request deletion of your personal information |
| `privacyPolicy.yourRights.export` | Export your data in a portable format |
| `privacyPolicy.yourRights.intro` | You have the right to: |
| `privacyPolicy.yourRights.object` | Object to processing of your personal information |
| `privacyPolicy.yourRights.title` | Your Rights |

### `shared/resetPassword/resetPassword.ar.ts` (AR)

| Key | Value |
|-----|-------|
| `resetPassword.invalidResetLink` | Reset Password |
| `resetPassword.passwordRequirements` | Reset Password |
| `resetPassword.passwordsDoNotMatch` | Reset Password |
| `resetPassword.passwordStrength` | Reset Password |
| `resetPassword.requirement8Chars` | Reset Password |
| `resetPassword.requirementLowercase` | Reset Password |
| `resetPassword.requirementNumber` | Reset Password |
| `resetPassword.requirementSpecial` | Reset Password |
...
| Key | Value |
|-----|-------|
| `termsOfService.acceptance.content` | By accessing or using our platform, you acknowledge that you have read, under... |
| `termsOfService.acceptance.title` | Acceptance of Terms |
| `termsOfService.account.accurate` | Provide accurate and complete information |
| `termsOfService.account.intro` | To use our services, you must: |
| `termsOfService.account.maintain` | Maintain the security of your account credentials |
| `termsOfService.account.notify` | Notify us immediately of any unauthorized access |
| `termsOfService.account.responsible` | Be responsible for all activities under your account |
| `termsOfService.account.title` | Account Registration |
| `termsOfService.changes.content` | We may modify these Terms at any time. We will notify you of any material cha... |
| `termsOfService.changes.title` | Changes to Terms |
| `termsOfService.contact.content` | If you have any questions about these Terms of Service, please contact us at ... |
| `termsOfService.contact.title` | Contact Us |
| `termsOfService.intellectualProperty.content` | All content, features, and functionality of the platform are owned by Nazim S... |
| `termsOfService.intellectualProperty.title` | Intellectual Property |
| `termsOfService.introduction.content` | These Terms of Service ("Terms") govern your access to and use of the Nazim S... |
| `termsOfService.introduction.title` | Introduction |
| `termsOfService.lastUpdated` | Last Updated: January 2026 |
| `termsOfService.liability.content` | To the maximum extent permitted by law, Nazim School Management System shall ... |
| `termsOfService.liability.title` | Limitation of Liability |
| `termsOfService.subscription.cancellation` | You may cancel your subscription at any time. Cancellation will take effect a... |
| `termsOfService.subscription.content` | Subscription fees are billed in advance on a monthly or annual basis. All fee... |
| `termsOfService.subscription.title` | Subscription and Payment |
| `termsOfService.termination.content` | We reserve the right to suspend or terminate your account at any time for vio... |
| `termsOfService.termination.title` | Termination |
| `termsOfService.title` | Terms of Service |
| `termsOfService.use.permitted.content` | You may use our services for lawful educational and administrative purposes o... |
| `termsOfService.use.permitted.title` | Permitted Use |
| `termsOfService.use.prohibited.interfere` | Interference with the platform's operation |
| `termsOfService.use.prohibited.malicious` | Introduction of viruses, malware, or harmful code |
| `termsOfService.use.prohibited.title` | Prohibited Activities |
| `termsOfService.use.prohibited.unauthorized` | Unauthorized access to other accounts or systems |
| `termsOfService.use.prohibited.violate` | Violation of any applicable laws or regulations |
| `termsOfService.use.title` | Use of Services |

### `shared/toast/toast.ar.ts` (AR)

| Key | Value |
|-----|-------|
| `toast.allStudentsEnrolled` | All students enrolled |
| `toast.articleCreated` | Article created successfully |
| `toast.articleCreateFailed` | Failed to create article |
| `toast.articleDeleted` | Article deleted successfully |
| `toast.articleDeleteFailed` | Failed to delete article |
| `toast.articleUpdated` | Article updated successfully |
| `toast.articleUpdateFailed` | Failed to update article |
| `toast.mediaCreated` | Media created successfully |
| `toast.mediaCreateFailed` | Failed to create media |
| `toast.mediaUpdated` | Media updated successfully |
| `toast.mediaUpdateFailed` | Failed to update media |
| `toast.mediaDeleted` | Media deleted successfully |
| `toast.mediaDeleteFailed` | Failed to delete media |
| `toast.mediaCategoryCreated` | Media category created successfully |
| `toast.mediaCategoryCreateFailed` | Failed to create media category |
| `toast.mediaCategoryUpdated` | Media category updated successfully |
| `toast.mediaCategoryUpdateFailed` | Failed to update media category |
| `toast.mediaCategoryDeleted` | Media category deleted successfully |
| `toast.mediaCategoryDeleteFailed` | Failed to delete media category |
| `toast.attendanceDeleted` | Attendance record deleted |
| `toast.attendanceDeleteFailed` | Failed to delete attendance |
| `toast.attendanceMarked` | Attendance marked |
| `toast.attendanceMarkFailed` | Failed to mark attendance |
| `toast.attendanceUpdated` | Attendance updated successfully |
| `toast.attendanceUpdateFailed` | Failed to update attendance |
| `toast.categoryCreateFailed` | Failed to create category |
| `toast.categoryDeleteFailed` | Failed to delete category |
| `toast.categoryUpdateFailed` | Failed to update category |
| `toast.certificates.revoked` | Certificate revoked |
| `toast.certificates.revokeFailed` | Failed to revoke certificate |
| `toast.classAssigned` | Class assigned to exam |
| `toast.classAssignFailed` | Failed to assign class |
| `toast.classRemoved` | Class removed from exam |
| `toast.classRemoveFailed` | Failed to remove class |
| `toast.currencyConversionFailed` | Failed to convert currency |
| `toast.currencyCreated` | Currency created successfully |
| `toast.currencyCreateFailed` | Failed to create currency |
| `toast.currencyDeleted` | Currency deleted successfully |
| `toast.currencyDeleteFailed` | Failed to delete currency |
| `toast.currencyUpdated` | Currency updated successfully |
| `toast.currencyUpdateFailed` | Failed to update currency |
| `toast.defaultTemplateSet` | Default template set successfully |
| `toast.defaultTemplateSetFailed` | Failed to set default template |
| `toast.departmentCreated` | Department created successfully |
| `toast.departmentCreateFailed` | Failed to create department |
| `toast.departmentDeleted` | Department deleted successfully |
| `toast.departmentDeleteFailed` | Failed to delete department |
| `toast.departmentNameRequired` | Department name is required |
| `toast.departmentUpdated` | Department updated successfully |
| `toast.departmentUpdateFailed` | Failed to update department |
| `toast.discountCodeCreated` | Discount code created successfully |
| `toast.discountCodeDeleted` | Discount code deleted |
| `toast.discountCodeUpdated` | Discount code updated |
| `toast.enrollAllFailed` | Failed to enroll all students |
| `toast.eventCreated` | Event created successfully |
| `toast.eventDeleted` | Event deleted successfully |
| `toast.eventTypeCreated` | Event type created successfully |
| `toast.eventTypeDeleted` | Event type deleted successfully |
| `toast.eventTypeUpdated` | Event type updated successfully |
| `toast.eventUpdated` | Event updated successfully |
| `toast.examCreated` | Exam created successfully |
| `toast.examCreateFailed` | Failed to create exam |
| `toast.examDeleted` | Exam deleted successfully |
| `toast.examDeleteFailed` | Failed to delete exam |
| `toast.examPaperTemplateCreated` | Exam paper template created successfully |
| `toast.examPaperTemplateCreateFailed` | Failed to create template |
| `toast.examPaperTemplateDeleted` | Exam paper template deleted successfully |
| `toast.examPaperTemplateDeleteFailed` | Failed to delete template |
| `toast.examPaperTemplateDuplicated` | Exam paper template duplicated successfully |
| `toast.examPaperTemplateDuplicateFailed` | Failed to duplicate template |
| `toast.examPaperTemplateUpdated` | Exam paper template updated successfully |
| `toast.examPaperTemplateUpdateFailed` | Failed to update template |
| `toast.examResultDeleted` | Result deleted successfully |
| `toast.examResultDeleteFailed` | Failed to delete result |
| `toast.examResultSaved` | Result saved successfully |
| `toast.examResultSaveFailed` | Failed to save result |
| `toast.examResultsSaved` | Exam results saved |
| `toast.examResultsSaveFailed` | Failed to save results |
| `toast.examResultUpdated` | Result updated successfully |
| `toast.examResultUpdateFailed` | Failed to update result |
| `toast.examStatusUpdated` | Exam status updated successfully |
| `toast.examStatusUpdateFailed` | Failed to update status |
| `toast.examSubjectUpdated` | Subject updated |
| `toast.examSubjectUpdateFailed` | Failed to update subject |
| `toast.examTimeCreated` | Time slot created |
| `toast.examTimeCreateFailed` | Failed to create time slot |
| `toast.examTimeDeleted` | Time slot deleted |
| `toast.examTimeDeleteFailed` | Failed to delete time slot |
| `toast.examTimeLocked` | Time slot locked |
| `toast.examTimeLockToggled` | Time slot lock toggled |
| `toast.examTimeLockToggleFailed` | Failed to toggle lock |
| `toast.examTimeUnlocked` | Time slot unlocked |
| `toast.examTimeUpdated` | Time slot updated |
| `toast.examTimeUpdateFailed` | Failed to update time slot |
| `toast.examTypes.created` | Exam type created successfully |
| `toast.examTypes.createFailed` | Failed to create exam type |
| `toast.examTypes.deleted` | Exam type deleted successfully |
| `toast.examTypes.deleteFailed` | Failed to delete exam type |
| `toast.examTypes.updated` | Exam type updated successfully |
| `toast.examTypes.updateFailed` | Failed to update exam type |
| `toast.examUpdated` | Exam updated successfully |
| `toast.examUpdateFailed` | Failed to update exam |
| `toast.exchangeRateCreated` | Exchange rate created successfully |
| `toast.exchangeRateCreateFailed` | Failed to create exchange rate |
| `toast.exchangeRateDeleted` | Exchange rate deleted successfully |
| `toast.exchangeRateDeleteFailed` | Failed to delete exchange rate |
| `toast.exchangeRateUpdated` | Exchange rate updated successfully |
| `toast.exchangeRateUpdateFailed` | Failed to update exchange rate |
| `toast.expenseEntryCreated` | Expense entry created successfully |
| `toast.expenseEntryDeleted` | Expense entry deleted successfully |
| `toast.expenseEntryUpdated` | Expense entry updated successfully |
| `toast.featureAddonAdded` | Feature addon added |
| `toast.feeAssignmentDeleted` | Fee assignment deleted |
| `toast.feeAssignmentDeleteFailed` | Fee assignment delete failed |
| `toast.feeAssignmentUpdated` | Fee assignment updated |
| `toast.feeAssignmentUpdateFailed` | Fee assignment update failed |
| `toast.feeExceptionDeleted` | Fee exception deleted |
| `toast.feeExceptionDeleteFailed` | Fee exception delete failed |
| `toast.feeExceptionUpdated` | Fee exception updated |
| `toast.feeExceptionUpdateFailed` | Fee exception update failed |
| `toast.feeStructureUpdateFailed` | Fee structure update failed |
| `toast.fieldsSaved` | Fields saved successfully |
| `toast.finance.accounts.account` | Finance Account |
| `toast.finance.assets` | Assets |
| `toast.finance.converted` | Converted |
| `toast.finance.currency` | Currency |
| `toast.finance.documents` | Documents |
| `toast.finance.file` | File |
| `toast.financeAccountCreated` | Account created successfully |
| `toast.financeAccountCreateFailed` | Failed to create account |
| `toast.financeAccountDeleted` | Account deleted successfully |
| `toast.financeAccountDeleteFailed` | Failed to delete account |
| `toast.financeAccountUpdated` | Account updated successfully |
| `toast.financeAccountUpdateFailed` | Failed to update account |
| `toast.financeDocumentCreated` | Finance document created |
| `toast.financeDocumentCreateFailed` | Finance document create failed |
| `toast.financeDocumentDeleted` | Finance document deleted |
| `toast.financeDocumentDeleteFailed` | Finance document delete failed |
| `toast.financeDocumentDownloadFailed` | Finance document download failed |
| `toast.financeProjectCreated` | Project created successfully |
| `toast.financeProjectDeleted` | Project deleted successfully |
| `toast.financeProjectUpdated` | Project updated successfully |
| `toast.graduation.attendance.title` | Attendance Requirements |
| `toast.graduation.batchApproved` | Graduation batch approved |
| `toast.graduation.batchApproveFailed` | Failed to approve graduation batch |
| `toast.graduation.batchCreated` | Graduation batch created successfully |
| `toast.graduation.batchCreateFailed` | Failed to create graduation batch |
| `toast.graduation.batches.description` | Create a new graduation batch. Configure the graduation type, select classes,... |
| `toast.graduation.cannotChangeTypeWithStudents` | Cannot change type when batch has students |
| `toast.graduation.certificatesIssued` | Certificates issued successfully |
| `toast.graduation.classTransfer` | Class Transfer Information |
| `toast.graduation.dashboard.certificatesThisYear` | Certificates Issued This Year |
| `toast.graduation.dashboard.createBatch` | Create New Batch |
| `toast.graduation.dashboard.createBatchDesc` | Start a new graduation batch |
| `toast.graduation.dashboard.currentYearBatches` | Current Year Batches |
| `toast.graduation.dashboard.issuedCertificates` | Issued Certificates |
| `toast.graduation.dashboard.issuedCertificatesDesc` | View all issued certificates |
| `toast.graduation.dashboard.noPendingApprovals` | No pending approvals |
| `toast.graduation.dashboard.noSchools` | No schools available. Please contact your administrator. |
| `toast.graduation.dashboard.pendingApprovals` | Pending Approvals |
| `toast.graduation.dashboard.quickActions` | Quick Actions |
| `toast.graduation.dashboard.recentBatches` | Recent Batches |
| `toast.graduation.dashboard.selectSchool` | Please select a school above to view graduation data. |
| `toast.graduation.dashboard.title` | Graduation Dashboard |
| `toast.graduation.dashboard.upcomingGraduations` | Upcoming Graduations |
| `toast.graduation.dashboard.viewTemplates` | View Templates |
| `toast.graduation.dashboard.viewTemplatesDesc` | Manage certificate templates |
| `toast.graduation.deleteConfirm` | Are you sure you want to delete this graduation batch? This action cannot be ... |
| `toast.graduation.editBatchDescription` | Update the graduation batch settings. Some fields may be locked if students h... |
| `toast.graduation.exams.equalWeights` | Distribute Equally |
| `toast.graduation.exams.totalWeight` | Total Weight |
| `toast.graduation.exams.weights` | Exam Weights |
| `toast.graduation.filters.dateFrom` | From Date |
| `toast.graduation.filters.dateTo` | To Date |
| `toast.graduation.filters.searchPlaceholder` | Search by year, class, exam... |
| `toast.graduation.fromClass` | From Class |
| `toast.graduation.graduationType` | Type |
| `toast.graduation.issueFailed` | Failed to issue certificates |
| `toast.graduation.noBatches.description` | Get started by creating your first graduation batch |
| `toast.graduation.noBatches.title` | No Graduation Batches |
| `toast.graduation.pagination.of` | of |
| `toast.graduation.pagination.showing` | Showing |
| `toast.graduation.selectFromClass` | Select From Class |
| `toast.graduation.selectSchoolDescription` | Please select a school from the filters above to view graduation batches |
| `toast.graduation.selectToClass` | Select To Class |
| `toast.graduation.status.approved` | Approved |
| `toast.graduation.status.draft` | Draft |
| `toast.graduation.status.issued` | Issued |
| `toast.graduation.studentsGenerated` | Eligible students generated |
| `toast.graduation.studentsGenerateFailed` | Failed to generate students for batch |
| `toast.graduation.summary.approvedBatches` | Approved |
| `toast.graduation.summary.draftBatches` | Draft |
| `toast.graduation.summary.issuedBatches` | Issued |
| `toast.graduation.summary.totalBatches` | Total Batches |
| `toast.graduation.table.students` | students |
| `toast.graduation.toClass` | To Class |
| `toast.graduation.transferringTo` | Transferring to |
| `toast.graduation.type.finalYear` | Final Year |
| `toast.graduation.type.promotion` | Promotion |
| `toast.graduation.type.transfer` | Transfer |
| `toast.graduation.types.finalYear` | Final Year Graduation |
| `toast.graduation.types.promotion` | Promotion |
| `toast.graduation.types.transfer` | Transfer |
| `toast.graduation.validation.weightsMustSum100` | Weights must sum to 100% |
| `toast.graduation.batchUpdated` | batch Updated |
| `toast.graduation.batchDeleted` | batch Deleted |
| `toast.guestAdded` | Guest added successfully |
| `toast.guestCheckedIn` | Guest checked in successfully |
| `toast.guestStatusUpdated` | Guest status updated successfully |
| `toast.guestUpdated` | Guest updated successfully |
| `toast.idCardAssignFailed` | Id card assign failed |
| `toast.idCardDeleted` | Id card deleted |
| `toast.idCardDeleteFailed` | Id card delete failed |
| `toast.idCardDownloadFailed` | Failed to download ID card PDF |
| `toast.idCardExported` | ID card PDF downloaded |
| `toast.idCardExportFailed` | Id card export failed |
| `toast.idCardFeeMarkedPaid` | Id card fee marked paid |
| `toast.idCardFeeMarkPaidFailed` | Id card fee mark paid failed |
| `toast.idCardMarkedPrinted` | Id card marked printed |
| `toast.idCardMarkPrintedFailed` | Id card mark printed failed |
| `toast.idCardPreviewFailed` | Student data not available |
| `toast.idCardsAssigned` | Id cards assigned |
| `toast.idCardsExported` | Id cards exported |
| `toast.idCardTemplateCreated` | ID card template created successfully |
| `toast.idCardTemplateCreateFailed` | Failed to create ID card template |
| `toast.idCardTemplateDeleted` | ID card template deleted successfully |
| `toast.idCardTemplateDeleteFailed` | Failed to delete ID card template |
| `toast.idCardTemplateSetDefault` | Default ID card template set successfully |
| `toast.idCardTemplateSetDefaultFailed` | Failed to set default ID card template |
| `toast.idCardTemplateUpdated` | ID card template updated successfully |
| `toast.idCardTemplateUpdateFailed` | Failed to update ID card template |
| `toast.idCardUpdated` | Id card updated |
| `toast.idCardUpdateFailed` | Id card update failed |
| `toast.incomeEntryCreated` | Income entry created successfully |
| `toast.incomeEntryDeleted` | Income entry deleted successfully |
| `toast.incomeEntryUpdated` | Income entry updated successfully |
| `toast.letterTypeCreated` | Letter type created successfully |
| `toast.letterTypeCreateFailed` | Failed to create letter type |
| `toast.letterTypeDeleted` | Letter type deleted successfully |
| `toast.letterTypeDeleteFailed` | Failed to delete letter type |
| `toast.letterTypeUpdated` | Letter type updated successfully |
| `toast.letterTypeUpdateFailed` | Failed to update letter type |
| `toast.library.bookRemoved` | Library book removed successfully |
| `toast.library.bookRemoveFailed` | Failed to remove library book |
| `toast.library.bookReturned` | Book returned successfully |
| `toast.library.bookReturnFailed` | Failed to return book |
| `toast.library.bookSaved` | Library book saved successfully |
| `toast.library.bookSaveFailed` | Failed to save library book |
| `toast.library.bookUpdated` | Library book updated successfully |
| `toast.library.bookUpdateFailed` | Failed to update library book |
| `toast.library.copyAdded` | Book copy added successfully |
| `toast.library.copyAddFailed` | Failed to add book copy |
| `toast.library.loanCreated` | Book loan created successfully |
| `toast.library.loanCreateFailed` | Failed to create book loan |
| `toast.limitOverrideAdded` | Limit override added |
| `toast.marksSaved` | Marks saved successfully |
| `toast.marksSaveFailed` | Failed to save marks |
| `toast.paymentConfirmed` | Payment confirmed successfully |
| `toast.paymentFailed` | Failed to submit payment |
| `toast.paymentRejected` | Payment rejected |
| `toast.paymentSubmitted` | Payment submitted successfully |
| `toast.permissionGroupAssignFailed` | Failed to assign permission group |
| `toast.permissionGroupCreated` | Permission group created successfully |
| `toast.permissionGroupCreateFailed` | Failed to create permission group |
| `toast.permissionGroupDeleted` | Permission group deleted successfully |
| `toast.permissionGroupDeleteFailed` | Failed to delete permission group |
| `toast.permissionGroupRemoveFailed` | Failed to remove permission group |
| `toast.permissionGroupUpdated` | Permission group updated successfully |
| `toast.permissionGroupUpdateFailed` | Failed to update permission group |
| `toast.planCreated` | Plan created successfully |
| `toast.planUpdated` | Plan updated successfully |
| `toast.previewFailed` | Failed to preview assignment |
| `toast.questionAdded` | Question added to template |
| `toast.questionAddFailed` | Failed to add question |
| `toast.questionCreated` | Question created successfully |
| `toast.questionCreateFailed` | Failed to create question |
| `toast.questionDeleted` | Question deleted successfully |
| `toast.questionDeleteFailed` | Failed to delete question |
| `toast.questionDuplicated` | Question duplicated successfully |
| `toast.questionDuplicateFailed` | Failed to duplicate question |
| `toast.questionRemoved` | Question removed from template |
| `toast.questionRemoveFailed` | Failed to remove question |
| `toast.questionsReordered` | Questions reordered |
| `toast.questionsReorderFailed` | Failed to reorder questions |
| `toast.questionsUpdated` | Questions updated successfully |
| `toast.questionsUpdateFailed` | Failed to update questions |
| `toast.questionUpdated` | Question updated successfully |
| `toast.questionUpdateFailed` | Failed to update question |
| `toast.renewalApproved` | Renewal request approved |
| `toast.renewalRejected` | Renewal request rejected |
| `toast.renewalRequestFailed` | Failed to submit renewal request |
| `toast.renewalRequestSubmitted` | Renewal request submitted successfully |
| `toast.rollNumberAssignFailed` | Failed to assign roll numbers |
| `toast.rollNumbersAssigned` | Roll numbers assigned |
| `toast.rollNumbersAssignedWithErrors` | Roll numbers assigned with errors |
| `toast.rollNumberUpdated` | Roll number updated |
| `toast.rollNumberUpdateFailed` | Failed to update roll number |
| `toast.secretNumberAssignFailed` | Failed to assign secret numbers |
| `toast.secretNumbersAssigned` | Secret numbers assigned |
| `toast.secretNumbersAssignedWithErrors` | Secret numbers assigned with errors |
| `toast.secretNumberUpdated` | Secret number updated |
| `toast.secretNumberUpdateFailed` | Failed to update secret number |
| `toast.studentEnrollFailed` | Failed to enroll student |
| `toast.studentsEnrolled` | Students enrolled |
| `toast.studentsEnrolledWithSkipped` | Students enrolled with skipped |
| `toast.studentsEnrollFailed` | Failed to enroll students |
| `toast.subjectEnrolled` | Subject added to exam |
| `toast.subjectEnrollFailed` | Failed to add subject |
| `toast.subjectRemoved` | Subject removed from exam |
| `toast.subscriptionActivated` | Subscription activated successfully |
| `toast.subscriptionSuspended` | Subscription suspended |
| `toast.templateFileCreated` | Template file created successfully |
| `toast.templateFileCreateFailed` | Failed to create template file |
| `toast.templateFileDeleted` | Template file deleted successfully |
| `toast.templateFileDeleteFailed` | Failed to delete template file |
| `toast.templateFileSetDefault` | Template file set as default |
| `toast.templateFileSetDefaultFailed` | Failed to set default template file |
| `toast.templateFileUpdated` | Template file updated successfully |
| `toast.templateFileUpdateFailed` | Failed to update template file |
| `toast.permissionsUpdated` | permissions Updated |
| `toast.discipline.created` | created |
| `toast.discipline.updated` | updated |
| `toast.discipline.deleted` | deleted |
| `toast.discipline.resolved` | resolved |
| `toast.incomeCategoryCreated` | income Category Created |
| `toast.incomeCategoryUpdated` | income Category Updated |
| `toast.incomeCategoryDeleted` | income Category Deleted |
| `toast.expenseCategoryCreated` | expense Category Created |
| `toast.expenseCategoryUpdated` | expense Category Updated |
| `toast.expenseCategoryDeleted` | expense Category Deleted |
| `toast.donorCreated` | donor Created |
| `toast.donorUpdated` | donor Updated |
| `toast.donorDeleted` | donor Deleted |
| `toast.leaveRequests.created` | created |
| `toast.leaveRequests.updated` | updated |
| `toast.leaveRequests.approved` | approved |
| `toast.leaveRequests.rejected` | rejected |
| `toast.libraryCategories.created` | created |
| `toast.libraryCategories.updated` | updated |
| `toast.libraryCategories.deleted` | deleted |
| `toast.staff.created` | created |
| `toast.staff.updated` | updated |
| `toast.staff.deleted` | deleted |
| `toast.staff.documentDeleted` | document Deleted |
| `toast.staffTypes.created` | created |
| `toast.staffTypes.updated` | updated |
| `toast.staffTypes.deleted` | deleted |
| `toast.studentAdmissions.admitted` | admitted |
| `toast.studentAdmissions.updated` | updated |
| `toast.studentAdmissions.removed` | removed |
| `toast.reportGenerationTimeout` | report Generation Timeout |
