...
export function ClassesManagement() {
    ...
    const hasCreatePermission = useHasPermission('academic.classes.create');
    const hasUpdatePermission = useHasPermission('academic.classes.update');
    const hasDeletePermission = useHasPermission('academic.classes.delete');
    const hasAssignPermission = useHasPermission('academic.classes.assign');
    const hasCopyPermission = useHasPermission('academic.classes.copy');
