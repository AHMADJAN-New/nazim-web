...
export function SubjectsManagement() {
    ...
    const hasCreatePermission = useHasPermission('academic.subjects.create');
    const hasUpdatePermission = useHasPermission('academic.subjects.update');
    const hasDeletePermission = useHasPermission('academic.subjects.delete');
    const hasAssignPermission = useHasPermission('academic.subjects.assign');
    const hasCopyPermission = useHasPermission('academic.subjects.copy');
