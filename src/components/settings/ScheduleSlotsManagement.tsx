...
export function ScheduleSlotsManagement() {
    ...
    const hasCreatePermission = useHasPermission('academic.schedule_slots.create');
    const hasUpdatePermission = useHasPermission('academic.schedule_slots.update');
    const hasDeletePermission = useHasPermission('academic.schedule_slots.delete');
