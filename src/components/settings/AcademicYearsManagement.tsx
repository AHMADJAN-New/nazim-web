...
export function AcademicYearsManagement() {
  ...
  const hasCreatePermission = useHasPermission('academic.academic_years.create');
  const hasUpdatePermission = useHasPermission('academic.academic_years.update');
  const hasDeletePermission = useHasPermission('academic.academic_years.delete');
