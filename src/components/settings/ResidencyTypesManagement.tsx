...
export function ResidencyTypesManagement() {
  ...
  const hasCreatePermission = useHasPermission('academic.residency_types.create');
  const hasUpdatePermission = useHasPermission('academic.residency_types.update');
  const hasDeletePermission = useHasPermission('academic.residency_types.delete');
